...
Ext.define('ianMizi.view.AyohaStoreSaleItem.FloatPanel_AyohaStore_PaymentHistory', {

});

var _FloatPanel_AyohaStore_PaymentHistory;


var isFloatPanel_AyohaStore_PaymentHistoryOpen = 'N';
...
function FloatPanel_AyohaStore_PaymentHistory() {

    _FloatPanel_AyohaStore_PaymentHistory =
    Ext.create('Ext.Container', {
        ...
        height: '100%',
        width: '100%',
        id: 'FloatPanel_AyohaStore_PaymentHistoryID',
        draggable: false,
   ...
   // style: 'background-color:white;',
    style: GetbackgroundColor(),
      //  style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
        ...
        //                //}
        //                if (e.direction == "left") {
        //                    _FloatPanel_AyohaStore_PaymentHistory.hide(Ext.fx.Animation({
        //                        type: 'slideOut',
        //                        direction: 'left',
        //                        easing: 'cubic-bezier(.7,0,.7,1)',
        //                        duration: 250
        ...
        items: [

            {
                ...
                id: 'containerFloatPanel_AyohaStore_PaymentHistoryHeader',
                       ...
                       [
{
    ...
    width:20
                        ...
                        {
                            margin: '0 0 0 0',
                            id: 'htmlFloatPanel_AyohaStore_PaymentHistory_TitleHeaderTxt',
                            html: '<font size=4 color=black><b>Payment History</b></font>'
                        },
...
html:'<div class="search-container">'+
    '<input type="text" id="input-PaymentHistorySearchText"  placeHolder="Search (Member Name / Phone No/Order No)" class="search-input" >'+
'</div>'
                        },
                        ...
                        },
                        {
                                ...
                                html: '<div style="color:black;text-align: left;font-size:16px;width:100%;paddign:0px 20px"><select style="font-size:16px;width:180px;height:30px"  id="FloatPanel_AyohaStore_PaymentHistory_Selection"><option value="NA"> - Filter - </option><option value="Today">Today</option><option value="ThisWeek">This Week</option><option value="Month">This Month</option><option value="Year">This Year</option><option value="Custome">Custome Date</option></select></div>'  
...

                                    {
                                     ...
                                     {
                                        xtype: 'button',
                                        id: 'btnFloatPanel_AyohaStore_PaymentHistoryBack',
                                        height: 30,
                                        width: 35,
                                        margin: '10 0 0 0',
                                        // iconCls: 'list',
                                        ...
                                        ui: 'plain',
                                        handler: function () {
                                           // FloatPanel_AyohaStore_PaymentHistoryHide();
                                          isFloatPanel_AyohaStore_PaymentHistoryOpen = 'N';
                                        ...
                                        document.getElementById("input-PaymentHistorySearchText").value=" ";
                                    ...
                                    //    },
                                              {
                                                  ...
                                                  width: 70,
                                                  // margin: '70 0 0 0',
                                                  id: 'containerFloatPanel_AyohaStore_PaymentHistoryHaiUser',
                                                  layout: {
                                                  ...
                                                  items: [
                                                      ...
                                                      {
                                                          margin: '0 0 0 0',
                                                          id: 'htmlFloatPanel_AyohaStore_PaymentHistoryHaiUser',
                                                      ...
                                                      },
                                                      {
                                                          ...
                                                          width: 70,
                                                          // margin: '70 0 0 0',
                                                          id: 'containerFloatPanel_AyohaStore_PaymentHistoryeWallet',
                                                          layout: {
                                                          ...
                                                          items: [
                                                               {
                                                                   xtype: 'button',
                                                                   id: 'btnFloatPanel_AyohaStore_PaymentHistoryeWallet',
                                                                   margin: '4 0 0 -15',
                                                                   height: 30,
                                                                   width: 35,
                                                                   // iconCls: 'list',
                                              ...
                                              },
                                           {
                                               ...
                                               width: 40,
                                               // margin: '70 0 0 0',
                                               id: 'containerFloatPanel_AyohaStore_PaymentHistoryPictureUser',
                                               layout: {
                                               ...
                                               items: [
                                                   {
                                                       ...
                                                       width: 40,
                                                       margin: '0 0 0 -11',
                                                       id: 'btnFloatPanel_AyohaStore_PaymentHistoryInfo',
                                                       //badgeText: "2",
...

            {
               ...
               // style: 'background-image: url("resources/icons/border7.png"); background-size: 100% 100%;border-top:1px solid #EAEEF3;',
                ...
                items: [
                    ...
                    //      width: '48%',
                    //      height: 20,
                    //      html: '<input type="text" id="input-PaymentHistorySearchText" placeHolder="Search (Member Name / Phone No/Order No)" style="border-color:purple;color:black;width:100%;text-align: center;font-size:12px;">'
                    //  },
                     {
                        margin: '0 0 0 20',
                        //hidden:true,
                       // id: 'htmlFloatPanel_AyohaStore_PaymentHistory_Count',
...
hidden:true,
                                ...
                                items: [
                                    {
                                      //ori  html: '<div class="x-list-item x-stretched x-list-item-tpl x-list-item-relative x-item-selected"><div class="x-innerhtml" style="padding: 12px;"><div style="overflow:auto;width:100%;height:100%;font-size: 65%;"><span style="font-family: Arial; text-transform:uppercase;"><div style="float:left;width:4%"><span style="font-family: Arial; text-transform:uppercase;"><b>No</div ><div style="float:left;width:15%"><span style="font-family: Arial; text-transform:uppercase;">Notification Code</div ><div style="float:left;width:35%"><span style="font-family: Arial; text-transform:uppercase;">Title</div ><div style="float:left;width:11%;"><b>Publish By</b></div><div style="float:left;width:20%;"><b>Publish Date</b></div><div style="float:left;width:15%;"><b>Audience</b></div></div></div></div>'
                                       ...
                                       // html: '<div class="x-list-item x-stretched x-list-item-tpl x-list-item-relative x-item-selected" style="background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);"><div class="x-innerhtml" style="padding: 12px;"><div style="overflow:auto;width:100%;height:100%;font-size: 65%;"><span style="font-family: Arial; text-transform:uppercase;"><div style="float:left;width:2.5%"><span style="font-family: Arial; text-transform:uppercase;"><b>No</div ><div style="float:left;width:16%"><span style="font-family: Arial; text-transform:uppercase;">Members Name</div ><div style="float:left;width:15%;"><b>Redeem Date</b></div><div style="float:left;width:12%;"><b>Redeem Info</b></div><div style="float:left;width:12.2%;"><b>Redeem Prize</b></div><div style="float:left;width:10%;"><b>Redeem Status</b></div></div></div></div>'
                                        html: '<div class="x-list-item x-stretched x-list-item-tpl x-list-item-relative x-item-selected" style="'+GetTableListHeader()+'"><div class="x-innerhtml" style="padding: 12px;"><div style="overflow:auto;width:100%;height:100%;"><span style="'+GetTableListTextHeader()+'"><div style="float:left;width:3%;"><span style="padding:0px 13px"><b>No</b></span></div ><div style="float:left;width:17.8%;"><b>Members Name / Phone No</b></div ><div style="float:left;width:14%;"><b>Payment No</b></div><div style="float:left;width:12.5%;"><b>Payment Method</b></div><div style="float:left;width:15%;"><b>Payment Date</b></div><div style="float:left;width:23%;"><b>Order No</b></div><div style="float:left;width:10%;"><b>Payment Amount</b></div><div style="float:left;width:4%;"><b>Status</b></div></div></div></div>'
                                 ...
                                 // height: 639,
                                  ...
                                  items: [
...

                                    {
                                        xtype: 'list',
                                        //  flex: 1,
                                        store: _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore,
                                        ...
                                        //        '</div>',
                                              ...
                                              '<div style="background-color: transparent;overflow:hidden"><div class="x-innerhtml" style="padding: 12px;overflow-x: hidden;"><div style="overflow:hidden;width:100%;height:100%;font-size: 65%;"><span style="font-family: Arial;"><div style="float:left;width:2%;"><span style="font-family: Arial; text-transform:uppercase;color:#71797E;font-size:12px;font-weight:bold">{Row_num}).</div ><div  style="float:left;width:18.4%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:bold">{ClientName}<br>({ClientPhoneNo})</div ><div style="float:left;width:14%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:normal">{PaymentNoDisplay}</div><div style="float:left;width:13%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:normal">{PaymentMethod}</div><div style="float:left;width:15%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:normal">{CreatedDate}</div><div style="float:left;width:24%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:normal">{OrderNo}</div><div style="float:left;width:10%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:16px;font-weight:bold;">RM{PaymentAmount}</div><div style="float:left;width:3%;font-family:'+GetListFontStyle()+'; color:blue;font-size:12px;font-weight:normal;bold;cursor: pointer;"   onclick="FloatPanel_AyohaStore_OrderHistoryLoadByOrderNoMerchantShow(`{OrderNo}`,`1`)"><u>{PaymentStatus}</u></div></div></div></div></div>'+
                                    ...
                                    //       id: 'FloatPanel_AyohaStore_PaymentHistory_MembershipApprovalListID',                                         
                                    //       // grouped: true,
                                    //       mode: 'SINGLE',
                                    //       //scrollable: {
                                    //       //    direction: 'vertical',
                                    ...
                                    //           '<div style="background-color: transparent;overflow:hidden"><div class="x-innerhtml" style="padding: 12px;overflow-x: hidden;"><div style="overflow:hidden;width:100%;height:100%;font-size: 65%;"><span style="font-family: Arial;"><div style="float:left;width:2%;"><span style="font-family: Arial; text-transform:uppercase;color:#71797E;font-size:12px;font-weight:bold">{RowNumber}).</div ><div style="float:left;width:6.5%;"><span style="font-family: Arial; text-transform:uppercase;color:#71797E;"><img  onClick="FloatPanel_AyohaStore_PaymentHistory_ExpandMembershipSummary_fromMembershipApprovalList({ID});" src="{Photo}" alt="Image" style="width: 80px; height: 80px; margin:0px 0px 0px 0px;border-radius:50%;cursor: pointer"/></span></div ><div onClick="FloatPanel_AyohaStore_PaymentHistory_ExpandMembershipSummary_fromMembershipApprovalList({ID});" style="float:left;width:18.4%;font-family: Arial; color:#71797E;font-size:12px;font-weight:bold;cursor: pointer"><u>{ModifiedAccountName}</u><br><u>{PhoneNo}</u></div ><div style="float:left;width:13%;color:#71797E;">{ModifiedMembershipCardBg}</div><div style="float:left;width:15.5%;color:#71797E;">{ModifiedMembershipCardName}</div><div style="float:left;width:13%;color:#71797E;">{ModifiedMembershipApprovalDate}</div><div style="float:left;width:12.5%;color:#71797E;">{ModifiedMembershipEndDate}</div><div style="float:left;width:10.5%;color:#71797E;">{ModifiedMembershipsRenewalInfo}</div><div style="float:left;width:6%;color:#71797E;">{ModifiedMembershipsApprovalStatus}</div></div></div></div>'+
    ...
    return _FloatPanel_AyohaStore_PaymentHistory;
...
function FloatPanel_AyohaStore_PaymentHistoryMemberShow() {

    Ext.Viewport.remove(_FloatPanel_AyohaStore_PaymentHistory);
    this.overlay = Ext.Viewport.add(FloatPanel_AyohaStore_PaymentHistory());
    this.overlay.show();
    isFloatPanel_AyohaStore_PaymentHistoryOpen = 'Y';
    _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.clearFilter();
   // FloatPanel_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore(GetCurrentYear());
    FloatPanel_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore('Year','00','00');
   document.getElementById("input-PaymentHistorySearchText").addEventListener("keyup", SearchPaymentHistorySearch);
   // FloatPanel_AyohaStore_PaymentHistoryMember_MembershipsLoadByEnterpriseAccNoApprovalListStore();
    FloatPanel_DrawerMenu_MainHide();
 //   document.getElementById("input-PaymentHistorySearchText").value="";


 var selectElement = document.getElementById('FloatPanel_AyohaStore_PaymentHistory_Selection');
 ...
 selectElement.addEventListener('change', function() {
     ...
     handleFilterChange_AyohaStore_PaymentHistory(selectedValue);
 });
   
}
function handleFilterChange_AyohaStore_PaymentHistory(filter) {
    switch (filter) {
        case 'Today':

        FloatPanel_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore(filter,'00','00');
            break;
        case 'ThisWeek':
            FloatPanel_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore(filter,'00','00');
            break;
...
function FloatPanel_AyohaStore_PaymentHistoryHide() {
    // FloatPanel_AyohaStore_PaymentHistory_AddCardHide();
   // FloatPanel_SubscriberMenuHide();
   if(isFloatPanel_AyohaStore_PaymentHistoryOpen == 'Y')
   {
    _FloatPanel_AyohaStore_PaymentHistory.hide(); isFloatPanel_AyohaStore_PaymentHistoryOpen = 'N';
   }
...
function FloatPanel_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore(DashboardFilter,StartDate,EndDate) {
   // _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.clearFilter();
  



    _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getProxy().setExtraParam('EnterpriseAccNo', GetEnterpriseAccNo());
    _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getProxy().setExtraParam('DashboardFilter', DashboardFilter);
    _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getProxy().setExtraParam('StartDate', StartDate);
    _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getProxy().setExtraParam('EndDate', EndDate);
    _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getProxy().setUrl(GetAPIurl() + '/AyohaStorePayment/AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchant');
 
    _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.load();


    var task = Ext.create('Ext.util.DelayedTask', function () {
      //  _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.load();
   // alert(_DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getCount())
    //    var Store = _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getAt(0);
    //    globalCountOrder=Store.get('TotalRow');
       Ext.getCmp('htmlFloatPanel_AyohaStore_PaymentHistory_Count').setHtml('<font size="2" color="black"><b>(' + _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getCount() + ')</b></font>');
...
function SearchPaymentHistorySearch() {
    ...
    var queryString = document.getElementById('input-PaymentHistorySearchText').value;
    ...
    if (queryString) {
        ...
        _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.filterBy(function (record) {
            if (thisRegEx.test(record.get('SearchCol'))) {
                console.log('ada0');

              countOrder = _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.getCount();
              Ext.getCmp('htmlFloatPanel_AyohaStore_PaymentHistory_Count').setHtml('<font size="2" color="black"><b>(' + countOrder + ')</b></font>');
                return true;
     ...
     //   Ext.getCmp('htmlMembershipApprovalListTypeLbl').setHtml('<font size="2" color="black"><b>All Cards(' + countEnterprise + ')</b></font>');
        ...
        console.log('tiada2');
        _DataStore_AyohaStorePaymentLoadByEnterpriseAccNoPaymentHistoryMerchantStore.clearFilter();
        Ext.getCmp('htmlFloatPanel_AyohaStore_PaymentHistory_Count').setHtml('<font size="2" color="black"><b>(' + globalCountOrder + ')</b></font>');
