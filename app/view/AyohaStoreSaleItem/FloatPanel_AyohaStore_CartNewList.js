...
Ext.define('ianMizi.view.AyohaStoreSaleItem.FloatPanel_AyohaStore_CartNewList', {

});

var _FloatPanel_AyohaStore_CartNewList;


var isFloatPanel_AyohaStore_CartNewListOpen = 'N';
...
function FloatPanel_AyohaStore_CartNewList() {

    _FloatPanel_AyohaStore_CartNewList =
    Ext.create('Ext.Container', {
        ...
        height: '100%',
        width: '100%',
        id: 'FloatPanel_AyohaStore_CartNewListID',
        draggable: false,
   ...
   // style: 'background-color:white;',
    style: GetbackgroundColor(),
      //  style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
        ...
        //                //}
        //                if (e.direction == "left") {
        //                    _FloatPanel_AyohaStore_CartNewList.hide(Ext.fx.Animation({
        //                        type: 'slideOut',
        //                        direction: 'left',
        //                        easing: 'cubic-bezier(.7,0,.7,1)',
        //                        duration: 250
        ...
        items: [

            {
                ...
                id: 'containerFloatPanel_AyohaStore_CartNewListHeader',
                       ...
                       [
{
    ...
    width:20
                        ...
                        {
                            margin: '0 0 0 0',
                            id: 'htmlFloatPanel_AyohaStore_CartNewList_TitleHeaderTxt',
                            html: '<font size=4 color=black><b>Client Shopping Cart History</b></font>'
                        },
...
html:'<div class="search-container">'+
    '<input type="text" id="input-NewCartHistorySearchText"  placeHolder="Search (Member Name / Phone No/Item Name)" class="search-input" >'+
'</div>'
                        },
                        ...
                        },
                        {
                                ...
                                html: '<div style="color:black;text-align: left;font-size:16px;width:100%;paddign:0px 20px"><select style="font-size:16px;width:180px;height:30px"  id="FloatPanel_AyohaStore_CartNewList_Selection"><option value="NA"> - Filter - </option><option value="Today">Today</option><option value="ThisWeek">This Week</option><option value="Month">This Month</option><option value="Year">This Year</option><option value="Custome">Custome Date</option></select></div>'  
...

                                    {
                                     ...
                                     {
                                        xtype: 'button',
                                        id: 'btnFloatPanel_AyohaStore_CartNewListBack',
                                        height: 30,
                                        width: 35,
                                        margin: '10 0 0 0',
                                        // iconCls: 'list',
                                        ...
                                        ui: 'plain',
                                        handler: function () {
                                           // FloatPanel_AyohaStore_CartNewListHide();
                                          isFloatPanel_AyohaStore_CartNewListOpen = 'N';
                                        ...
                                        document.getElementById("input-NewCartHistorySearchText").value=" ";
                                    ...
                                    //    },
                                              {
                                                  ...
                                                  width: 70,
                                                  // margin: '70 0 0 0',
                                                  id: 'containerFloatPanel_AyohaStore_CartNewListHaiUser',
                                                  layout: {
                                                  ...
                                                  items: [
                                                      ...
                                                      {
                                                          margin: '0 0 0 0',
                                                          id: 'htmlFloatPanel_AyohaStore_CartNewListHaiUser',
                                                      ...
                                                      },
                                                      {
                                                          ...
                                                          width: 70,
                                                          // margin: '70 0 0 0',
                                                          id: 'containerFloatPanel_AyohaStore_CartNewListeWallet',
                                                          layout: {
                                                          ...
                                                          items: [
                                                               {
                                                                   xtype: 'button',
                                                                   id: 'btnFloatPanel_AyohaStore_CartNewListeWallet',
                                                                   margin: '4 0 0 -15',
                                                                   height: 30,
                                                                   width: 35,
                                                                   // iconCls: 'list',
                                              ...
                                              },
                                           {
                                               ...
                                               width: 40,
                                               // margin: '70 0 0 0',
                                               id: 'containerFloatPanel_AyohaStore_CartNewListPictureUser',
                                               layout: {
                                               ...
                                               items: [
                                                   {
                                                       ...
                                                       width: 40,
                                                       margin: '0 0 0 -11',
                                                       id: 'btnFloatPanel_AyohaStore_CartNewListInfo',
                                                       //badgeText: "2",
...

            {
               ...
               // style: 'background-image: url("resources/icons/border7.png"); background-size: 100% 100%;border-top:1px solid #EAEEF3;',
                ...
                items: [
                    ...
                    //      width: '48%',
                    //      height: 20,
                    //      html: '<input type="text" id="input-NewCartHistorySearchText" placeHolder="Search (Member Name / Phone No/Order No)" style="border-color:purple;color:black;width:100%;text-align: center;font-size:12px;">'
                    //  },
                     {
                        margin: '0 0 0 20',
                        //hidden:true,
                       // id: 'htmlFloatPanel_AyohaStore_CartNewList_Count',
...
hidden:true,
                                 ...
                                 // id: 'containerMembershipApprovalListList',
                                  ...
                                  items: [
...

                                    {
                                        xtype: 'list',
                                        //  flex: 1,
                                        store: _DataStore_AyohaStoreCartNewCartMerchantStore,
                                        ...
                                        //        '</div>',
                                              ...
                                              '<div style="background-color: transparent;overflow:hidden"><div class="x-innerhtml" style="padding: 12px;overflow-x: hidden;"><div style="overflow:hidden;width:100%;height:100%;font-size: 65%;"><span style="font-family: Arial;"><div style="float:left;width:2%;"><span style="font-family: Arial; text-transform:uppercase;color:#71797E;font-size:12px;font-weight:bold">{RowNumber}).</div ><div  style="float:left;width:18.4%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:bold">{AccountName}<br>({PhoneNo})</div ><div style="float:left;width:15.5%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:normal">{ItemName}</div><div style="float:left;width:13.5%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:normal">{ItemQuantity}</div><div style="float:left;width:16%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:normal">{ItemPrice}</div><div style="float:left;width:15.8%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:12px;font-weight:normal">{CreatedDate}</div><div style="float:left;width:10%;font-family:'+GetListFontStyle()+'; color:'+GetListFontColor()+';font-size:16px;font-weight:bold;">RM{ItemSumPrice}</div><div style="float:left;width:3%;font-family:'+GetListFontStyle()+'; color:blue;font-size:12px;font-weight:normal;bold;cursor: pointer;"   onclick="FloatPanel_AyohaStore_OrderHistoryLoadByOrderNoMerchantShow(`{OrderNo}`,`1`)"><u>{PaymentStatus}</u></div></div></div></div></div>'+
                                        ...
                                        emptyText: '<img src="resources/icons/noOrder.png" style="width:62px;height:62px;"><br>No Cart Order',
                                        width: '100%',
                                        height: '100%',
                                    ...
                                    //       id: 'FloatPanel_AyohaStore_CartNewList_MembershipApprovalListID',                                         
                                    //       // grouped: true,
                                    //       mode: 'SINGLE',
                                    //       //scrollable: {
                                    //       //    direction: 'vertical',
                                    ...
                                    //           '<div style="background-color: transparent;overflow:hidden"><div class="x-innerhtml" style="padding: 12px;overflow-x: hidden;"><div style="overflow:hidden;width:100%;height:100%;font-size: 65%;"><span style="font-family: Arial;"><div style="float:left;width:2%;"><span style="font-family: Arial; text-transform:uppercase;color:#71797E;font-size:12px;font-weight:bold">{RowNumber}).</div ><div style="float:left;width:6.5%;"><span style="font-family: Arial; text-transform:uppercase;color:#71797E;"><img  onClick="FloatPanel_AyohaStore_CartNewList_ExpandMembershipSummary_fromMembershipApprovalList({ID});" src="{Photo}" alt="Image" style="width: 80px; height: 80px; margin:0px 0px 0px 0px;border-radius:50%;cursor: pointer"/></span></div ><div onClick="FloatPanel_AyohaStore_CartNewList_ExpandMembershipSummary_fromMembershipApprovalList({ID});" style="float:left;width:18.4%;font-family: Arial; color:#71797E;font-size:12px;font-weight:bold;cursor: pointer"><u>{ModifiedAccountName}</u><br><u>{PhoneNo}</u></div ><div style="float:left;width:13%;color:#71797E;">{ModifiedMembershipCardBg}</div><div style="float:left;width:15.5%;color:#71797E;">{ModifiedMembershipCardName}</div><div style="float:left;width:13%;color:#71797E;">{ModifiedMembershipApprovalDate}</div><div style="float:left;width:12.5%;color:#71797E;">{ModifiedMembershipEndDate}</div><div style="float:left;width:10.5%;color:#71797E;">{ModifiedMembershipsRenewalInfo}</div><div style="float:left;width:6%;color:#71797E;">{ModifiedMembershipsApprovalStatus}</div></div></div></div>'+
    ...
    return _FloatPanel_AyohaStore_CartNewList;
...
function FloatPanel_AyohaStore_CartNewListShow() {

    Ext.Viewport.remove(_FloatPanel_AyohaStore_CartNewList);
    this.overlay = Ext.Viewport.add(FloatPanel_AyohaStore_CartNewList());
    this.overlay.show();
    isFloatPanel_AyohaStore_CartNewListOpen = 'Y';
    _DataStore_AyohaStoreCartNewCartMerchantStore.clearFilter();
    FloatPanel_AyohaStoreCartNewCartMerchantStore('Year');
   document.getElementById("input-NewCartHistorySearchText").addEventListener("keyup", SearchNewCartHistorySearch);
   // FloatPanel_AyohaStore_CartNewListMember_MembershipsLoadByEnterpriseAccNoApprovalListStore();
    FloatPanel_DrawerMenu_MainHide();
 //   document.getElementById("input-NewCartHistorySearchText").value="";


 var selectElement = document.getElementById('FloatPanel_AyohaStore_CartNewList_Selection');
...
function handleFilterChange(filter) {
    switch (filter) {
        case 'Today':
            FloatPanel_AyohaStoreCartNewCartMerchantStore(filter);
            break;
        case 'ThisWeek':
            FloatPanel_AyohaStoreCartNewCartMerchantStore(filter);
            break;
...
function FloatPanel_AyohaStore_CartNewListHide() {
    // FloatPanel_AyohaStore_CartNewList_AddCardHide();
   // FloatPanel_SubscriberMenuHide();
   if(isFloatPanel_AyohaStore_CartNewListOpen == 'Y')
   {
    _FloatPanel_AyohaStore_CartNewList.hide(); isFloatPanel_AyohaStore_CartNewListOpen = 'N';
   }
...
function FloatPanel_AyohaStoreCartNewCartMerchantStore(DashboardFilter) {
   // _DataStore_AyohaStoreCartNewCartMerchantStore.clearFilter();
  



    _DataStore_AyohaStoreCartNewCartMerchantStore.getProxy().setExtraParam('EnterpriseAccNo', GetEnterpriseAccNo());
    _DataStore_AyohaStoreCartNewCartMerchantStore.getProxy().setExtraParam('DashboardFilter', DashboardFilter);
    _DataStore_AyohaStoreCartNewCartMerchantStore.getProxy().setUrl(GetAPIurl() + '/AyohaStore_Cart/AyohaStoreCartNewCartMerchant');
 
    _DataStore_AyohaStoreCartNewCartMerchantStore.load();


    var task = Ext.create('Ext.util.DelayedTask', function () {
      //  _DataStore_AyohaStoreCartNewCartMerchantStore.load();
   //alert(_DataStore_AyohaStoreCartNewCartMerchantStore.getCount())
    //    var Store = _DataStore_AyohaStoreCartNewCartMerchantStore.getAt(0);
    //    globalCountOrder=Store.get('TotalRow');
       Ext.getCmp('htmlFloatPanel_AyohaStore_CartNewList_Count').setHtml('<font size="2" color="black"><b>(' + _DataStore_AyohaStoreCartNewCartMerchantStore.getCount() + ')</b></font>');
...
function SearchNewCartHistorySearch() {
    ...
    var queryString = document.getElementById('input-NewCartHistorySearchText').value;
    ...
    if (queryString) {
        ...
        _DataStore_AyohaStoreCartNewCartMerchantStore.filterBy(function (record) {
            if (thisRegEx.test(record.get('SearchCol'))) {
                console.log('ada0');

              countOrder = _DataStore_AyohaStoreCartNewCartMerchantStore.getCount();
              Ext.getCmp('htmlFloatPanel_AyohaStore_CartNewList_Count').setHtml('<font size="2" color="black"><b>(' + countOrder + ')</b></font>');
                return true;
     ...
     //   Ext.getCmp('htmlMembershipApprovalListTypeLbl').setHtml('<font size="2" color="black"><b>All Cards(' + countEnterprise + ')</b></font>');
        ...
        console.log('tiada2');
        _DataStore_AyohaStoreCartNewCartMerchantStore.clearFilter();
        Ext.getCmp('htmlFloatPanel_AyohaStore_CartNewList_Count').setHtml('<font size="2" color="black"><b>(' + globalCountOrder + ')</b></font>');
