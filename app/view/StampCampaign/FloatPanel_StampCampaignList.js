...
Ext.define('ianMizi.view.StampCampaign.FloatPanel_StampCampaignList', {
                        ...
                        items: [
                            {
                                ...
                                items:
                                       [
                                                     ...
                                                     },
                                                     {
                                                         ...
                                                         html: '<font size=2 color=white><b>Customer Info</b></font>'
                                                     },
                                                      {
                                                          xtype: 'spacer',
...

                                                              {
                                                                  ...
                                                                  width: 70,
                                                                  // margin: '70 0 0 0',
                                                                  id: 'containerFloatPanel_StampCampaignListHaiUser',
                                                                  layout: {
                                                                  ...
                                                                  items: [
                                                                      ...
                                                                      {
                                                                          margin: '0 0 0 0',
                                                                          id: 'htmlFloatPanel_StampCampaignListHaiUser',
                                                                      ...
                                                                      },
                                                                      {
                                                                          ...
                                                                          width: 70,
                                                                          // margin: '70 0 0 0',
                                                                          id: 'containerFloatPanel_StampCampaignListeWallet',
                                                                          layout: {
                                                                          ...
                                                                          items: [
                                                                               {
                                                                                   xtype: 'button',
                                                                                   id: 'btnFloatPanel_StampCampaignListeWallet',
                                                                                   margin: '4 0 0 -15',
                                                                                   height: 30,
                                                                                   width: 35,
                                                                                   // iconCls: 'list',
                                                              ...
                                                              },
                                                           {
                                                               ...
                                                               width: 40,
                                                               // margin: '70 0 0 0',
                                                               id: 'containerFloatPanel_StampCampaignListPictureUser',
                                                               layout: {
                                                               ...
                                                               items: [
                                                                   {
                                                                       ...
                                                                       width: 40,
                                                                       margin: '0 0 0 -11',
                                                                       id: 'btnFloatPanel_StampCampaignListInfo',
                                                                       //badgeText: "2",
...

                              {
                                  ...
                                  // hidden: true,
                                  //  hidden:true,
                                  id: 'tabpanelFloatPanel_StampCampaignList',
                                  ...
                                  items: [
...

                                             {
                                                 ...
                                                 items: [
...

                                                      {
                                                          ...
                                                          id: 'FloatPanel_StampCampaignListLoyaltyCardID',
                                                          mode: 'SINGLE',
                                                          //grouped: true,
                                                         ...
                                                         //  '<table style="border-collapse:collapse;border-spacing:0;width:100%;background-color:#f44336;"><tr><th style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:0px 5px;border-style:none;border-width:2px;overflow:hidden;word-break:normal;text-align:center;border-color:#A2CDF5" rowspan="2"><img src="data:image/png;base64,{FlatBillImgLogo}"style="width: 72px; height: 62px; border:1px solid #A2CDF5; border-radius: 50%; max-width:200px; " /></th><th style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:0px 5px;border-style:none;border-width:2px;overflow:hidden;word-break:normal;border-color:#A2CDF5"><div class="blink_me" style="background-color: #f44336; color: white; padding: 5px 5px;text-align: center; text-decoration: none;font-size: 12px;margin: 0px 0px -20px 170px;cursor: pointer;width:55px" >New</div>{FlatBillWorkshop}<br>Desc:Unifi<br>Account No:1017345941<br>Date:{FlatBillDate}</th></tr><tr><td style="font-family:Arial, sans-serif;font-weight:bold;text-align:center;font-size:16px;padding:0px 5px;border-style:none;border-width:2px;overflow:hidden;word-break:normal;border-color:#A2CDF5;background-color:#1B1C1E;color:white;">Total Paid:RM{FlatBillFinalAmount}</td></tr></table>' +
                                                          ...
                                                          listeners: {
                                                              itemsingletap: function (list, idx, target, records, evt) {
                                                                  ...
                                                                  Load_FloatPanel_StampCampaignList_StampCardLoadByStampCampaignCodeEnterpriseAccNoStore(StampCampaignCode, EnterpriseAccNo)
                                                                  Ext.getCmp('tabpanelFloatPanel_StampCampaignList').setActiveItem(1);
                                                              },
                                       ...
                                       {
                                           xtype: 'container',
                                           id: 'containerFloatPanel_StampCampaignListCardListDetails',
                                           width: '100%',
                                           height: '100%',
                                           //style: "background-color: white;border-right:2px solid #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px #ECF0F1 white;border-radius: 50px 50px 50px 50px;",
                                           style: "background-color: transparent;",
                                           //style: "background-color: #F35B57;",
                                           title: 'FloatPanel_StampCampaignListCardListDetails',
                                           layout: {
                                               type: 'vbox',
                                               pack: 'center',
                                               align: 'center'
...

                                             {
                                                 ...
                                                 items: [
...

                                                         {
                                                             ...
                                                             items: [
...

                                                                     {
                                                                         ...
                                                                         width: '50%',
                                                                         html: '<div style="width:100%;text-align:left;color:black;font-family: Arial; font-size:12px;"> &nbsp;&nbsp;&nbsp;&nbsp;Stamp Card </div>'
                                                                     },
...

                                                      {
                                                          ...
                                                          id: 'FloatPanel_StampCampaignListLoyaltyCardDetailsID',
                                                          mode: 'SINGLE',
                                                        //  grouped: true,
                                                          disableSelection: true,
                                                          itemTpl: '<div class="myContent">' +
