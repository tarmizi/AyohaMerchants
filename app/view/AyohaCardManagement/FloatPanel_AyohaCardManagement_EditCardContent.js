                        ...
                        items: [
                            {
                                ...
                                html: '<font size=2 color=black><b>Edit Card Content</b></font>'
                            },
                             {
xtype:'spacer',
                             },
           ...
           items: [
                {
                ...
                },
                 {
                     ...
                     html: '<font size=1 color=black>Reset</font>',
           ...
           items: [
                 {
                     ...
                     html: '<font size=2 color=black>Row Text 1</font>',
...

                      {
                          ...
                          width: '80%',
                          height: 20,
                          html: '<input type="text" id="input-FloatPanel_AyohaCardManagement_EditCardContentCardRowText1"  onkeyup="onchangeEditCardContentCardRowText1()"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
                      },
...

                       {
                           ...
                           html: '<font size=2 color=black>Row Text 2</font>',
...

                      {
                          ...
                          width: '80%',
                          height: 20,
                          html: '<input type="text" id="input-FloatPanel_AyohaCardManagement_EditCardContentCardRowText2" onkeyup="onchangeEditCardContentCardRowText2()" style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
                      },
                                                      ...
                                                      items: [
                                                            {
                                                                ...
                                                                html: '<font size=2 color=black>*Uploaded Image limit to < 2MB</font>',
                                                     ...
                                                     
                               {
                                   ...
                                   //     html: '<button class="button3" style="width:165px;height:32px"><label for="imageUploadPicProfile" class="btn btn-primary btn-block btn-outlined" style="width:25px;height:32px">Upload Picture</label><input type="file" id="imageUploadPicProfile" accept="image/*" style="display: none;width:25px;height:32px" onchange="EnableuploadAccPicProfile()" /></button>',
...

                                            {
                                                ...
                                                width: '105%',
                                                height: 20,
                                                html: '<input type="text" id="inputName-FloatPanel_AyohaCardManagement_EditCardContent_UploadedImage" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
                                            },
                                                      ...
                                                      items: [
                                                            {
                                                                ...
                                                                html: '<font size=2 color=black>Content Status:</font>',

                                                            },
                                                             {
                                                                 margin: '0 0 0 0',
                                                                 id: 'htmlFloatPanel_AyohaCardManagement_EditCardContentShowHideTxt',
                                                                 html: '<font size=3 color=black>Show</font>',
                                                                 ...
                                                                 listeners: {
                                                                     change: function (field, newValue, oldValue) { // change function will be called whenever the toggle value changes
                                                                         ...
                                                                         if (newValue == true) { // if toggle is true then enable the slider
                                                                             ...
                                                                             globalShowHide = "Show";
                                                                             Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentShowHideTxt').setHtml('<font size=2 color=black>Show</font>');
                                                                             ...
                                                                             globalShowHide = "Hide";
                                                                             Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentShowHideTxt').setHtml('<font size=2 color=black>Hide</font>');;
                     ...
                     /////////
...

                       {
                           ...
                           html: '<font size=3 color=red>*</font><font size=2 color=black>Content Note</font>',
                                 ...
                                 },
                                 {
                                     ...
                                     html: '<font size=1 color=black>*This Content Note will pop up when user tap card content.</font>',
           ...
           
            {
                ...
                html: '<font size=2 color=black>is this Redeem item:NO</font>',
            ...
            },
                                                             {
                                                             ...
                                                             },
                                                              {
                                                                  ...
                                                                  html: '<font size=1 color=black>*isRedeem tag used to identify next reward in your customer loyalty card.</font>',
                                    ...
                                    items: [

                                         {
                                             ...
                                             handler: function () {
                                                 ...
                                                 Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentHeaderTxt').setHtml('<font size=2 color=black><b>Edit Card Content - Change Image</b></font>');
...
function SaveImageCardContent(ContentCardImg, EnterpriseAccNo, ContentCardImgNames) {
    var imgbase64;
    var contentNote =document.getElementById('input-ContentNote').value;
    ...
    if(contentNote){
        swalFireFail("Content Note Required");
    }else{
        return;
    }
