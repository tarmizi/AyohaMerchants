                            ...
                            //  html: '<img src="resources/icons/SaleThree.gif" width="250" height="250" alt="Company Name">',
                              ...
                              handler: function () {
                                  ...
                                  if (FloatPanel_AyohaCardManagement_Type == 'Point') {
                                      FloatPanel_AyohaCardManagement_AddCardForm_PointShow();
                                  }
                                  if (FloatPanel_AyohaCardManagement_Type == 'Discount') {
                                    FloatPanel_MerchantDiscountLoyaltySettingShow_AddNew();
                                }

                                if (FloatPanel_AyohaCardManagement_Type == 'Voucher') {
...
function FloatPanel_AyohaCardManagement_AddCardHide() {
   // alert(isFloatPanel_AyohaCardManagement_AddCardHide)
