...
var globalIsStampCampaignStartEndDateYesNo="NO";
...
function FloatPanel_AyohaCardManagement_EditCard() {
    ...
    _FloatPanel_AyohaCardManagement_EditCard = Ext.create('Ext.Container',
...

        {
                ...
                items: [
...

                 {
                     ...
                     items:
                            [
...

                                  {
                                    ...
                                    html: '<font size=3 color=black><b>Stamp Card Setting</b></font>'
                                },
...

                   {
                       xtype: 'container',
                       //margin: '10 0 0 0',
                       id:'containerFloatPanel_AyohaCardManagement_EditCard_bottombtn',
                       height:50,
                       width: '100%',
                       docked: 'bottom',
...

                    {
                        ...
                        items: [
...

                          {
                              ...
                              width: '80%',
                              height: 20,
                              html: '<input type="text" id="input-FloatPanel_AyohaCardManagement_EditCard_StampCardCampaignName"  style="border-color:black;color:grey;width:100%;text-align: left;font-size:12px;">'
                          },
...

                          {
                              ...
                              width: '80%',
                              height: 20,
                              html: '<input type="text" id="input-FloatPanel_AyohaCardManagement_EditCard_StampCardCampaignCode"  readOnly style="border-color:black;color:grey;width:100%;text-align: left;font-size:12px;">'
                          },
...

          {
          ...
          },
           {
               ...
               width: '40%',
               height: 20,
               html: '<input type="text" id="input-FloatPanel_AyohaCardManagement_EditCard_StampCardCardType"  readOnly style="border-color:black;color:grey;width:100%;text-align: left;font-size:12px;">'
           },
                         ...
                         items: [
...

                             {
                                 ...
                                 items: [
                                 {
                                     ...
                                     html: '<font size=2 color=black>Stamp Rule Amount</font>',
       ...
       {
           margin: '-2 0 0 0',
           id: 'FloatPanel_AyohaCardManagement_EditCard_StampRuleAmount',
           width: '100%',
           height: 20,
           html: '<input type="number" id="input-FloatPanel_AyohaCardManagement_EditCard_StampRuleAmount"  style="border-color:black;color:grey;width:100%;text-align: left;font-size:12px;">'
                      ...
                      //},
                        {
                            xtype: 'button',
                            id: 'btnFloatPanel_AyohaCardManagement_EditCard_StampRuleAmountInfo',
                            //  badgeText: '1',
                            margin: '0 0 -10 0',
                            height: 35,
                            width: 35,
                            ...
                            ui: 'plain',
                            handler: function () {
                                swalFireGeneralMsg("Amount that entitled to get card stamped");
                            }
                        },
                          ...
                          items: [
...

                              {
                                  ...
                                  items: [
                                  {
                                      ...
                                      html: '<font size=2 color=black>Stamp Rule Descriptions</font>',
...

        {
            ...
            width: '100%',
            height: 20,
            html: '<input type="text" id="input-FloatPanel_AyohaCardManagement_EditCard_StampRuleRemarks"  style="border-color:black;color:grey;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             html: '<font size=2 color=black>Pop Up Stamp Rule?</font>',
                ...
                change: function (field, newValue, oldValue) { // change function will be called whenever the toggle value changes
                    ...
                    if (newValue == true) { // if toggle is true then enable the slider
                        ...
                        if (val.length > 2) {
                            ...
                            Ext.getCmp('htmlisStampRulePopUpYesNo').setHtml('<font size=2 color=black>YES</font>');
                            Ext.getCmp('htmlisStampRulePopUpText').setHtml('<font size=2 color=black>(Stamp rule will be pop up before merchadiser started to stamp card)</font>');
                            Ext.getCmp('htmlisStampRulePopUpText').setHidden(false);
                            return;
                        } else {

                            swalFireFail("Stamp Rule is Empty!");
                            Ext.getCmp('htmlisStampRulePopUpYesNo').setHtml('<font size=2 color=black>NO</font>');
                            Ext.getCmp('htmlisStampRulePopUpText').setHtml('<font size=2 color=black>.</font>');
...

{
    ...
    html: '<font size=2 color=black>.</font>',
                   ...
                   items: [
                       {
                           ...
                           height: 5,
                           // width:20,
                           id: 'togglefieldFloatPanel_AyohaCardManagement_EditCard_Stamp_CampaignStartEndDateYesNo',
                           //label: 'Manual',
                           disabled: false,
                           value: false,
                           style: {
                           ...
                           listeners: {
                               change: function (field, newValue, oldValue) { // change function will be called whenever the toggle value changes
                                   ...
                                   if (newValue == true) { // if toggle is true then enable the slider
                                       ...
                                       Ext.getCmp('htmlStampCampaignStartEndDateYesNo').setHtml('<font size=2 color=black>YES</font>');
                                       Ext.getCmp('togglefieldFloatPanel_AyohaCardManagement_EditCard_Stamp_CampaignStartEndDateYesNo').setValue(true);
                                      // Ext.getCmp('container_FloatPanel_AyohaCardManagement_EditCard_Stamp_CampaignStartEndDateMaster').setHidden(false);
                                       Ext.getCmp('containerIsStampCampaignRequiredStartEndDateMaster').setHidden(false);
                                       globalIsStampCampaignStartEndDateYesNo = "YES";
                                       ...
                                       Ext.getCmp('htmlStampCampaignStartEndDateYesNo').setHtml('<font size=2 color=black>NO</font>');
                                       Ext.getCmp('togglefieldFloatPanel_AyohaCardManagement_EditCard_Stamp_CampaignStartEndDateYesNo').setValue(false);
                                      // Ext.getCmp('container_FloatPanel_AyohaCardManagement_EditCard_Stamp_CampaignStartEndDateMaster').setHidden(true);
                                       Ext.getCmp('containerIsStampCampaignRequiredStartEndDateMaster').setHidden(true);
                                       globalIsStampCampaignStartEndDateYesNo = "NO";
        ...
        {
            margin: '0 0 0 0',
            id: 'htmlStampCampaignStartEndDateYesNo',
            html: '<font size=2 color=black>NO</font>',
        ...
        {
            xtype: 'container',
            id:'containerIsStampCampaignRequiredStartEndDateMaster',
            width: '100%',
            layout: {
                type: 'vbox',
                pack: 'left',
...

                      {
                          ...
                          items: [
                              {
                                  ...
                                  html: '<font size=3 color=black>Rubber Stamp</font>',
                              ...
                              },
                          {
                             ...
                             // hidden:true,
                              ...
                              height: 35,
                              width: 35,
                              html: '<img src="resources/icons/StampTiltRightOne.png" width="25" height="25" alt="Company Name">',
                              ui: 'plain',
                              handler: function () {

                                swalFireGeneralMsg('Custome Stamp will be be available soon.!');
                              }
                          },
              {
                  xtype: 'button',
                 // hidden: true,
                  ...
                  height: 40,
                  width: 110,
                  html: '<font size=2 color=black>Custome Stamp</font>',
                  ui: 'plain',
                  handler: function () {
          ...
          items: [
              {
                  ...
                  html: '<font size=3 color=black>Enterprise Participated</font>',
          ...
          },
{
    ...
    handler: function () {
            ...
            //////////////////////////////////-Branch Participate
        {
            xtype: 'container',
            margin: '25 0 0 0',
            id:'containerFloatPanel_AyohaCardManagement_EditCard_AuthorizedStamper',
            width: '100%',
            style: {
            ...
            items: [
                {
                    ...
                    html: '<font size=3 color=black>Authorized Stamper</font>',
                ...
                },
            {
                ...
                height: 35,
                width: 35,
                html: '<img src="resources/icons/userInfoPurple.png" width="25" height="25" alt="Company Name">',
                ui: 'plain',
                handler: function () {
            ...
            },
{
    ...
    height: 40,
    width: 100,
    html: '<font size=2 color=black>Stamper(s)</font>',
    ui: 'plain',
    handler: function () {
        FloatPanel_AyohaCardManagement_UserEnterprisesListShow();
...

        {
            ...
            id: 'FloatPanel_AyohaCardManagement_EditCard_StamperListAdministrator',
            mode: 'SINGLE',
            //  grouped: true,
            disableSelection: true,
            itemTpl: '<div class="myContent">' +
...

        {
            ...
            height: 150,
            store: 'StampCampaignStamperLoadByStampCampaignCodeStore',
            id: 'FloatPanel_AyohaCardManagement_EditCard_StamperListStaff',
            mode: 'SINGLE',
            //  grouped: true,
            disableSelection: true,
            itemTpl: '<div class="myContent">' +
            ...
            items: [
                {
                    ...
                    html: '<font size=3 color=black>Card Contents</font>',
              ...
              height: 350,
               ...
               listeners: {
                   itemsingletap: function (list, idx, target, records, evt) {
                       ...
                       if (n) {
                           Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentHeaderTxt').setHtml('<font size=2 color=black><b>Edit Card Content - Upload Image</b></font>');
                           ...
                           Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentHeaderTxt').setHtml('<font size=2 color=black><b>Edit Card Content - Change Text</b></font>');
                       ...
                       if (ShowHide == "Show") {
                           ...
                           Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentShowHideTxt').setHtml('<font size=3 color=black>Show</font>');
                           globalShowHide = "Show";

                       } else {
                           Ext.getCmp('togglefieldFloatPanel_AyohaCardManagement_EditCardContentShowHide').setValue(false);
                           Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentShowHideTxt').setHtml('<font size=3 color=black>Hide</font>');
                           globalShowHide = "Hide";
                       }
                       ...
                       var CardType = document.getElementById('input-FloatPanel_AyohaCardManagement_EditCard_StampCardCardType').value;
                       if (CardType == "Auto-Default") {
                           Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentHeaderTxt').setHtml('<font size=2 color=black><b>Edit Card Content - Hide/Show Content</b></font>');
                           Ext.getCmp('btnFloatPanel_AyohaCardManagement_EditCardContent_SaveText').setHidden(true);
                           ...
                           Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentisRedeemitemTxt').setHtml('<font size=2 color=black>is this Redeem item:NO</font>');
                       ...
                       if (isRedeemItem == "YES") {
                           ...
                           Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentisRedeemitemTxt').setHtml('<font size=2 color=black>is this Redeem item:YES</font>');
                       }
                       if (isRedeemItem == "NO") {
                           Ext.getCmp('togglefieldFloatPanel_AyohaCardManagement_EditCardContentisRedeem').setValue(false);
                           Ext.getCmp('htmlFloatPanel_AyohaCardManagement_EditCardContentisRedeemitemTxt').setHtml('<font size=2 color=black>is this Redeem item:NO</font>');
                        ...
                        items: [
                            {
                                ...
                                html: '<font size=3 color=black>Card Background Image</font>',
               ...
               items: [

                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'container',
id:'containerFloatPanel_AyohaCardManagement_EditCard_UploadBackgroundImage',
                                    width: '100%',
                                    style: {
                                    ...
                                    items: [
                                             ...
                                             },
                                             {
                                              ...
                                              //  margin: '7 0 0 7',
                                                //height: 40,
                                                //width: 130,
                                                html: '<font size=2 color=black>Add Card Background Image</font>',
                                                ui: 'plain',
                                                handler: function () {
...

                          {
                              ...
                              hidden: true,
                              height: 20,
                              html: '<input type="text" id="input-FloatPanel_AyohaCardManagement_EditCard_StampCardBackgroundImage" readOnly style="border-color:black;color:grey;width:100%;text-align: left;font-size:12px;">'
                          },
        ...
        
         {
             ...
             html: '<font size=3 color=black>Card Background Image Animate Setting</font>',

         },
          {
              margin: '-1 0 0 0',
              id: 'htmlFloatPanel_AyohaCardManagement_EditCard_isAnimatedTxt',
              html: '<font size=2 color=black>Is Animated?</font>',
    ...
    items: [

        {
            ...
            listeners: {
                change: function (field, newValue, oldValue) { // change function will be called whenever the toggle value changes
                    ...
                    if (newValue == true) { // if toggle is true then enable the slider
                        ...
                        Ext.getCmp('htmlisAnimatedText').setHtml('<font size=3 color=black>YES</font>');
                        ...
                        //} else {
                        //    Ext.getCmp('htmlisAnimatedText').setHtml('<font size=3 color=black>NO</font><font size=2 color=black>(Background image will be set Randomly)</font>');
                        //    Ext.getCmp('htmlAnimatedIntervalText').setHidden(false);
                        //    Ext.getCmp('htmlAnimatedIntervalValue').setHidden(false);
                        //   // document.getElementById('input-FloatPanel_AyohaCardManagement_EditCard_AnimatedInterval').value = val;
        ...
        },
         {
             ...
             html: '<font size=3 color=black>No</font><font size=2 color=black>(Background image will be set Randomly)</font>',
...

{
    ...
    html: '<font size=2 color=black>Animate Interval(Second)</font>',
...

  {
      ...
      html: '<input type="number" id="input-FloatPanel_AyohaCardManagement_EditCard_AnimatedInterval"  style="border-color:black;color:grey;width:100%;text-align: left;font-size:12px;">'
  },
...
//        },
...

         {
...

           {
               ...
               html: '<font size=3 color=black>Stamp Campaign QR Code(Custome)</font>',
...

          {
              ...
              html: '<font size=3 color=black>Stamp Campaign QR Code(Standard)</font>',
...

           {
           ...
           },
             {
                ...
                // hidden: true,
                 ...
                 id: 'htmlFloatPanel_AyohaCardManagement_StampQrCode_EditCard',
...
function FloatPanel_AyohaCardManagement_EditCardShow(StampCampaignName, StampCampaignCode, CreatedBy, ModifiedBy, CreatedDate, ModifiedDate, StampCardType, StartDateOnly, EndDateOnly, BackgroundImage, isAnimated, AnimatedInterval, StampRuleRemarks,StampRuleAmount, isStampRulePopUp, LoyaltyCustomerType, StampCampaignPremiumQRCode, IsStampCampaignRequiredStartEndDate) {
    ...
    globalIsStampCampaignStartEndDateYesNo = IsStampCampaignRequiredStartEndDate;
    ...
    document.getElementById('input-FloatPanel_AyohaCardManagement_EditCard_StampRuleAmount').value = StampRuleAmount;
    ...
    if (IsStampCampaignRequiredStartEndDate == "NO") {
        Ext.getCmp('containerIsStampCampaignRequiredStartEndDateMaster').setHidden(true);
    }

    if (IsStampCampaignRequiredStartEndDate == "YES") {
        Ext.getCmp('containerIsStampCampaignRequiredStartEndDateMaster').setHidden(false);
    }
...
function saveEditCardMaster(RowStatus) {
    ...
    //alert(globalIsStampCampaignStartEndDateYesNo);
    //return;
    ...
    var checkStampruleAmount=parseFloat(document.getElementById('input-FloatPanel_AyohaCardManagement_EditCard_StampRuleAmount').value);
    ...
    if (checkStampruleAmount) {
      
    }else{
        swalFireFail("Stamp Amount Empty,Not Valid!!")
        return
    }

    if (checkStampruleAmount<1.00) {
        swalFireFail("Stamp Amount Not Valid!!,Must Greater than RM 1.00")
        return
    }
    ...
    if (globalIsStampCampaignStartEndDateYesNo == "YES") {
    ...
    Ext.Ajax.request({
        ...
        params: {
            ...
            StampRuleAmount: document.getElementById('input-FloatPanel_AyohaCardManagement_EditCard_StampRuleAmount').value,
            ...
            strEndDate: globalIsStampCampaignStartEndDateYesNo
