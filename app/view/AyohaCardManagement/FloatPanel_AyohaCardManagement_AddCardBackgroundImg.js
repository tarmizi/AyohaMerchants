                        ...
                        items: [
                            {
                                ...
                                width:20
                            },
                                          {
                                              ...
                                              html: '<font size=3 color=black><b>Add Background Card Image</b></font>'
                                          },
                                                      ...
                                                      items: [
                                                            {
                                                                ...
                                                                html: '<font size=2 color=black>*Uploaded Image limit to < 4MB</font>',
...

                               {
                                   ...
                                   //     html: '<button class="button3" style="width:165px;height:32px"><label for="imageUploadPicProfile" class="btn btn-primary btn-block btn-outlined" style="width:25px;height:32px">Upload Picture</label><input type="file" id="imageUploadPicProfile" accept="image/*" style="display: none;width:25px;height:32px" onchange="EnableuploadAccPicProfile()" /></button>',
...

                                            {
                                                ...
                                                width: '105%',
                                                height: 20,
                                                html: '<input type="text" id="inputName-FloatPanel_AyohaCardManagement_AddCardBackgroundImg_UploadedImage" readOnly style="border-color:black;color:grey;width:100%;text-align: left;font-size:12px;">'
                                            },
