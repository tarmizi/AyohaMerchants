...
width:20
                                          ...
                                          {
                                              margin: '0 0 0 0',
                                              html: '<font size=4 color=black><b>Branches List</b></font>'
                                          },
                                           {
                                               xtype: 'spacer',
                        ...
                        listeners: {
                            itemsingletap: function (list, idx, target, records, evt) {
                                ...
                                if (isFloatPanel_MembershipCardManagement_EditCardOpen == 'Y') {
                                    MembershipCardEnterprisesEntitledInsertUpdate(EnterpriseAccNo,EnterpriseHQAccNo);
                                    return
                                }
