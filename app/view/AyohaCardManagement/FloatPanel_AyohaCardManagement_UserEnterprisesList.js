                            ...
                            [

                                {
                                    ...
                                    width:20
                                          ...
                                          {
                                              margin: '0 0 0 0',
                                              html: '<font size=3 color=black><b>Staff List</b></font>'
                                          },
                                           {
                                               xtype: 'spacer',
                        ...
                        listeners: {
                            itemsingletap: function (list, idx, target, records, evt) {
                                ...
                                if (FloatPanel_AyohaCardManagement_Type == 'Point') {
                                    PointCampaignPointerInsertUpdate(0, AccountName, AccountNo, UserType);
                                }
                            },
...
function PointCampaignPointerInsertUpdate(ID, AccountName, AccountNo, UserType) {
    ...
    var _value = Ext.Ajax.request({
        ...
        url: GetAPIurl() + '/PointCampaignPointer/PointCampaignPointerInsertUpdate',
