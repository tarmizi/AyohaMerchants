...
{
    xtype: 'button',
    id: 'btnMyAccount_DashboardMenuBurger',
    height: 37,
    width: 50,
    margin:'3 0 0 0',
    // iconCls: 'list',
   // html: '<div ><img src="resources/icons/latestBurgerMenuWhite2.png" width="20" height="18" alt="Company Name"></div>',
   html: '<div ><img src="resources/icons/burgerMenu2.png" width="35" height="27" alt="Company Name"></div>',
    ui: 'plain',
    handler: function () {
...
hidden:true,
                                            ...
                                            '<input type="text" id="input-DashboardSubscriberListSearchText" onfocus="SearchMembersShow()" placeHolder="Search Members(Name/Mobile Phone No)" class="search-inputMaster" >'+
                                            '</div>'
                                                },
                                                {
                                                    xtype: 'spacer',
                                            ...
                                            
                                            {
                                                xtype: 'button',
                                               hidden:true,
                                                id: 'btnMyAccount_DashboardTopSearchMembers',
                                                height: 35,
                                                width: 45,
                                                margin:'3 0 0 0',
                                                // iconCls: 'list',
                                               // html: '<div ><img src="resources/icons/latestBurgerMenuWhite2.png" width="20" height="18" alt="Company Name"></div>',
                                               html: '<div ><img src="resources/icons/searchPurpleOne.png" width="25" height="25" alt="Company Name"></div>',
                                                ui: 'plain',
                                                handler: function () {
                                                    SearchMembersShow();
                                                   // Ext.getCmp('mainView').setHidden(true);
        ...
        
                {
                        ...
                        //  height: 230,
                         ...
                         items: [
                             ...
                             {
                                xtype: 'container',
                                name:'Dashboard_containerTotalMemberNumber',
                                margin:'-15 0 0 0',
                                width:220,
                                height:220,
                                cls:'example-1',
                                style: 'background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9); border-radius: 50%;border:2px solid #fac;cursor:pointer',
                                layout: {
                                    type: 'vbox',
                                    pack: 'center',
                                    align: 'center'
                                ...
                                items:[
                                    {
                                        html:'<img src="resources/icons/MembershipsMembersWhite.png" width="80" height="80" alt="Company Name">',
                                    },
                                    {
                                        id:'Dashboard_TotalMembers',
                                        html:'<div style="color:white;text-align: center;font-size:48px;width:100%;margin:-30px 0px 0px 0px;"><b>0</b></div>',
                                    },
                                    {
                                        html:'<div style="color:white;text-align: center;font-size:11px;width:100%;margin:-20px 0px 0px 0px"><b>Unique Members</b></div>'
                                    }
                                ]
                            },
                        ...
                        items:[
                            {
                                ...
                                margin: '0 0 0 20',
                                html: '<div style="color:black;text-align: left;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;width:100%;">Total Membership Fee Collection(YTD)</div>'
                              //  html: '<div style="color:black;text-align: left;font-size:11px;width:100%;">-Campaign Activity Summary-</div>',
                            },
                            {
                              //  hidden: true,
                              ...
                              //  id: 'htmlDashboard_AyohaPointCollected',
                                html: '<div style="color:black;text-align: center;font-size:25px;width:100%;"><b>RM0.00</b></div>'
                            }, 
                            {
                       
                                margin: '0 0 0 20',
                                html: '<div style="color:black;text-align: left;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;width:100%;">Average Membership Duration</div>'
                              //  html: '<div style="color:black;text-align: left;font-size:11px;width:100%;">-Campaign Activity Summary-</div>',
                            },
                            {
                              //  hidden: true,
                              margin: '-5 0 0 20',
                               // id: 'htmlDashboard_AyohaPointCollected',
                                html: '<div style="color:black;text-align: left;font-size:25px;width:100%;"><b>0 Year,0 Month - (NA)</b></div>'
                            }, 
                        ]
                    },
            ...
            items:[
...

                            {
                                // margin: '0 0 0 -80', 
                                 ...
                                 html: '<canvas id="chart_MembershipStatusBarChart" height="330px"></canvas>',
            ...
            items:[

                {
                    ...
                    items: [
                        ...
                        {
                            margin: '0 0 0 0',
                            id:'htmlDashboard_LatestActivityLblori',                                            
                            html: '<div style="color:black;text-align: left;font-size:16px;width:100%;"><b>Recent Activity</b></div>'
                          //  html: '<div style="color:black;text-align: left;font-size:11px;width:100%;">-Campaign Activity Summary-</div>',
                        },
                        {
       ...
       // hidden:true,
        ...
        items:[
            ...
            },
            {
                ...
                height:'95%',
                width:'97%',
             // html:'<div id="chart-container"><canvas id="membershipGrowthChart"></canvas></div>'
             html:'<canvas id="membershipGrowthChart" height="350px"></canvas>'
            }
        ]
        }
            ...
            items:[
                {
                   ...
                   // hidden:true,
                    //style: "background-color: white;border-right:2px solid #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px #ECF0F1 white;border-radius: 50px 50px 50px 50px;",
                    style: 'border:1px solid #CCCCCC;background-color:white;border-radius:3%',
                    layout: {
                        type: 'hbox',
                        pack: 'start',
                        align: 'center'
            ...
            items:[
                {
                 ...
                 itemTpl :'<div style="width: 180px; height: 335px;margin:0px 0px 0px 20px;"><div ondblclick="FloatPanel_SubscriberListMemberShow_Dashboard(' + "'" + '{AccountNo}' + "'" + ');" class="img" style="width: 180px; height: 335px; border-right:2px solid #ECECEC;border-left:2px solid #ECECEC;border-bottom:2px solid #ECECEC;border-top:2px solid #ECECEC;background-color: white;border-radius: 10px 10px 10px 10px;position: relative;margin:0px 0px 0px 0px;padding:0px 10px;"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:bold;word-break:normal;margin:0px 0px 0px 0px;color:purple;text-align:right;"><button onClick="FloatPanel_MessagingOptionShow(' + "'" + '{AccountNo}' + "'" + ',' + "'" + '{PhoneNo}' + "'" + ',' + "'" + '{Email}' + "'" + ',' + "'" + '{AccountName}' + "'" + ');" class="buttonAyohaNotificationMgmt" style="margin:0px 0px 0px 0px;"><img src="resources/icons/BlastingMsgPurple.png" style="width:22px;height:22px;margin:0px 0px -5px -40px;cursor: pointer;" alt="Company Name"></button><button  onclick="FloatPanel_SubscriberListMemberShow_Dashboard(' + "'" + '{AccountNo}' + "'" + ');" class="buttonAyohaNotificationMgmt" style="margin:0px 0px 0px 0px;"><img src="resources/icons/viewCardPurpleExt.png" style="width:22px;height:22px;margin:0px 0px -5px -40px;cursor: pointer;" alt="Company Name"></button></div><div style="font-family:Arial, sans-serif;font-size:12px;font-weight:bold;word-break:normal;"><br><br><img  src="{Photo}" style="width: 120px; height: 120px;display: block;border-radius:50%; margin-left: auto;margin-right: auto;display: block;border:2px purple solid;" /></div><img  src="resources/icons/happybirthday3.gif" style="width: 60px; height: 60px;display: block; margin-left: auto;margin-right: auto;display: block;margin:-25px 0px 0px 0px;border-radius:50%" /><br><div style="font-family:Arial, sans-serif;font-size:12px;font-weight:bold;word-break:normal;margin:-55px 0px 0px 13px;color:black;text-align:center;" class="blink_me">Date Of Birth<br>{DOB}</div><div style="font-family:Arial, sans-serif;font-size:12px;font-weight:bold;word-break:normal;margin:-15px 0px 0px 0px;color:black;text-align:center;"><br><br><br>{RowNumber}).{AccountName}<br>{Email}</div></div></div>',
...
var globalDashboard_TotalMember;
...
// alert(globalDashboard_LatestPointCampaignCode_SubscriberAccNo)
      ...
      globalDashboard_TotalMember=TotalMembers;
      Ext.getCmp('Dashboard_TotalMembers').setHtml('<div style="color:white;text-align: center;font-size:48px;width:100%;margin:-30px 0px 0px 0px;"><b>' + TotalMembers + '</b></div>');
     // Ext.getCmp('Dashboard_AyohaRewardPoint').setHtml('<div onclick="FloatPanel_SubscriberListShow()" class="example-1" style="background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9); border-radius: 50%;border:2px solid #fac;text-align:center;margin:-25px 0px 0px 0px;height:210px;width:210px"><div style="margin:35px 0px 0px 0px"><img src="resources/icons/MembershipsMembersWhite.png" width="80" height="80" alt="Company Name"></div><br><div style="color:white;text-align: center;font-size:48px;width:100%;margin:-50px 0px 0px 0px;"><b>' + TotalMembers + '</b></div><br><div style="color:white;text-align: center;font-size:11px;width:100%;margin:-38px 0px 0px 0px"><b>Members</b></div></div>');

       // Ext.getCmp('Dashboard_AyohaRewardPoint').setHtml('<div onclick="FloatPanel_SubscriberListShow()"  style="background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9); border-radius: 50%;border:2px solid #fac;text-align:center;margin:-30px 0px 0px 0px;height:210px;width:210px"><div style="margin:35px 0px 0px 0px"><img src="resources/icons/MembershipsMembersWhite.png" width="80" height="80" alt="Company Name"></div><br><div style="color:white;text-align: center;font-size:48px;width:100%;margin:-50px 0px 0px 0px;"><b>' + TotalMembers + '</b></div><br><div style="color:white;text-align: center;font-size:11px;width:100%;margin:-38px 0px 0px 0px"><b>Members</b></div></div>');
                ...
                if (data.success == "true") {
                    ...
                    if (data.total == 0) {
                     ...
                     if(globalDashboardeWalletCurrentBalance){
                        Ext.getCmp('htmlMyAccount_Dashboard_TitleHeaderTxtAyohaEwallet').setHtml('<div style="width:100%;background-color: transparent;text-align:right;border: 1px none white;font-size: 8px;font-weight:bold;color:black;margin:-3px 0px 0px 0px">Business Transaction Collection</div><br><div style="width:100%;background-color: transparent;text-align:right;border: 1px none white;font-size: 16px;font-weight:bold;color:black;margin:-22px 0px 0px 0px">RM' + globalDashboardeWalletCurrentBalance + '</div>');
                     }else{
...
var vals=$("#SelectionAyohaStoreDashboard option:selected" ).text();
 ...
 function Dashboardload_OrderAndPaymentChartx() {
    ...
    function Dashboardchart_MembershipStatusBarChartCount(){
        ...
        let chart_MembershipStatusBarChart;
        let apiData;
   ...
   chart_MembershipStatusBarChart = new Chart(ctx, {
       type: 'bar',
       data: {
           labels: labels,
           datasets: [{
   ...
   document.getElementById('chart_MembershipStatusBarChart').onclick = function(evt) {
       const activePoints = chart_MembershipStatusBarChart.getElementsAtEventForMode(evt, 'nearest', { intersect: true }, false);
       if (activePoints.length) {
           const index = activePoints[0].index;
           const selectedStatus = chart_MembershipStatusBarChart.data.labels[index];
           const selectedCount = chart_MembershipStatusBarChart.data.datasets[0].data[index];
         ...
         //  alert('You selected: ' + selectedStatus + ' with count: ' + selectedCount);
           FloatPanel_SubscriberListShow_FromMembershipsStatus(selectedStatus,selectedCount);
       }
   };
}
...
window.addEventListener('resize', function(){
    if (chart_MembershipStatusBarChart) {
    //this.alert('chart_MembershipStatusBarChart')
    chart_MembershipStatusBarChart.resize();
    }
});
...
let MembershipGrowthOverTime_chart;
...
async function drawChart_MembershipGrowthOverTime() {
    ...
    MembershipGrowthOverTime_chart = new Chart(ctx, {
    ...
    document.getElementById('membershipGrowthChart').onclick = function(evt) {
        const activePoints = MembershipGrowthOverTime_chart.getElementsAtEventForMode(evt, 'nearest', { intersect: true }, false);
        if (activePoints.length) {
            const index = activePoints[0].index;
            const selectedMonth = MembershipGrowthOverTime_chart.data.labels[index];
            const selectedCount = MembershipGrowthOverTime_chart.data.datasets[0].data[index];
...
window.addEventListener('resize', function(){
    if (MembershipGrowthOverTime_chart) {
       //this.alert('ddd')
        MembershipGrowthOverTime_chart.resize();
    }
});
