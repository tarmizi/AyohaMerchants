...
function FloatPanel_AyohaeWallet_TopUp() {
   ...
   var billExternalID = modifiedAccountNo[2] + '-50528-0133376958-NoEnterprise-' + billPaymentGateWayID_randomNo;
    ...
    $.ajax({
        ...
        url: "https://42.1.63.57/CRMOBILEAPI/PaymentGateway/PaymentGatewayCreateBill_eWalletTopUp?namBill=Ayoha Membership Bill&name=" + GetAyohaUserAccountNames() + "&hpNo=" + GetCurrentPhoneNumber() + " &billName=Ayoha Membership Fees&billDesc=Ayoha Membership Fees&billEmail=" + GetAyohaUserEmail() + "&billExternalID=" + billExternalID,
...
function FloatPanel_AyohaeWallet_getBillTransaction() {
    ...
    $.ajax({
        ...
        url: "https://42.1.63.57/CRMOBILEAPI/PaymentGateway/PaymentGatewayGetBillTransaction?billCode=18y5pena&billpaymentStatus=1",
        success: function (result) {
