...
var amount=parseFloat(document.getElementById("input-FloatPanel_AyohaeWallet_CashOut_AmountTransfer").value);
if(document.getElementById("input-FloatPanel_AyohaeWallet_CashOut_AmountTransfer").value){
    if(amount<=0.00){
        swalFireFail("Not Valid Amount");
        return
    }
    if(amount>globalDashboardeWalletCurrentBalance){
        swalFireFail("Not Valid Amount");
        return;
    }
}else{
