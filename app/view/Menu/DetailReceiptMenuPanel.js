...

                  {
                      ...
                      items: [
                        ...
                        //     html: '<img src="resources/icons/RedPrint.png" width="65" height="65" alt="Company Name">',
                             html: '<a href="https://setkita.com/PrintLink/?BillID='+FlatBillID+'&TemplateCode='+ReceiptTemplateCode+'" target="_blank"><img src="resources/icons/RedPrint.png" width="65" height="65" alt="Company Name"></a>',
                             //   html: '<div ><img src="resources/icons/DetailsPoint.png" width="45" height="45" alt="Company Name"></div>',
                           // ui: 'plain',
                           // handler: function () {
                           ...
                           ////      window.open("https://setkita.com/PrintLink/?BillID=' + FlatBillID + '&TemplateCode=' + ReceiptTemplateCode");
                           //     // testprintPDF();
