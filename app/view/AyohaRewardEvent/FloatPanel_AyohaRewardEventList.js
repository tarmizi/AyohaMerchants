...
Ext.define('ianMizi.view.AyohaRewardEvent.FloatPanel_AyohaRewardEventList', {

});

var _FloatPanel_AyohaRewardEventList;


var isFloatPanel_AyohaRewardEventListOpen = 'N';
...
function FloatPanel_AyohaRewardEventList() {

    _FloatPanel_AyohaRewardEventList =
    Ext.create('Ext.Container', {
        ...
        height: '100%',
        width: '100%',
        id: 'FloatPanel_AyohaRewardEventListID',
        draggable: false,
       ...
       //style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
        ...
        //                //}
        //                if (e.direction == "left") {
        //                    _FloatPanel_AyohaRewardEventList.hide(Ext.fx.Animation({
        //                        type: 'slideOut',
        //                        direction: 'left',
        //                        easing: 'cubic-bezier(.7,0,.7,1)',
        //                        duration: 250
                        ...
                        items: [
                            {
                                ...
                                id: 'containerFloatPanel_AyohaRewardEventListHeader',
                               // style: 'border-right:2px none #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px none #ECF0F1 ;background: white;box-shadow: 5px 10px 18px #888888;',
                                ...
                                items:
                                       [
                                           ...
                                           {
                                            margin: '0 0 0 0',
                                            id: 'htmlFloatPanel_AyohaRewardEventList_TitleHeaderTxt',
                                            html: '<font size=4 color=black><b>Membership Event Campaign Setting</b></font>'
                                        },
...
'<input type="text" id="input-FloatPanel_AyohaRewardEventList_ListTypeSearchTxt"  placeHolder="Search (Membership Event Name)" class="search-input" >'+
'</div>'
},
              {
                  xtype: 'spacer',
...

            {
                ...
                width:10
                                                      ...
                                                      {
                                                        xtype: 'button',
                                                        id: 'btnFloatPanel_AyohaRewardEventListBack',
                                                        height: 30,
                                                        width: 35,
                                                        // iconCls: 'list',
                                                        ...
                                                        ui: 'plain',
                                                        handler: function () {
                                                           // FloatPanel_AyohaRewardEventListHide();
                                                            // FloatPanel_AyohaRewardEventList_AddCardHide();
                                                            isFloatPanel_AyohaRewardEventListOpen = 'N';
                                                            _FloatPanel_AyohaRewardEventList.hide(Ext.fx.Animation({
                                                                type: 'popOut',
                                                                //direction: 'left',
                                                                easing: 'cubic-bezier(.7,0,.7,1)',
                                                    ...
                                                    },    
                                                    {
                                                       ...
                                                       // height: 30,
                                                        width: 20,
                                                            ...
                                                            {
                                                                xtype: 'button',
                                                                id: 'btnFloatPanel_AyohaRewardEventList_CardIcon',
                                                                height: 30,
                                                                width: 35,
                                                                hidden:true,
                                                                // iconCls: 'list',
...

 {
     ...
     width: 8,
                            ...
                            {
                                xtype: 'container',
                                id: 'containerFloatPanel_AyohaRewardEventListStampCardList',
                               // margin: '-10 0 0 0',
                                width: '100%',
                                height: '100%',
                                ...
                                title: 'FloatPanel_AyohaRewardEventListCardLis',
                                layout: {
                                    type: 'vbox',
                                    pack: 'center',
                                    align: 'center'
                                ...
                                //                    Ext.getCmp('tabpanelFloatPanel_AyohaRewardEventList').setActiveItem(0);
                                //                }
                                //            }
                                //        });
                                //    }
                                                           ...
                                                           
                                                              {
...

                                                                {
                                                                    ...
                                                                    items:[
                                                                        ...
                                                                        {
                                                                            margin: '0 0 0 0',
                                                                            id: 'htmlFloatPanel_AyohaRewardEventListCardCount',
                                                         ...
                                                         items: [
                                                               {
                                                                   ...
                                                                   margin: '2 0 0 0',
                                                                   id: 'btnFloatPanel_AyohaRewardEventListCardImage',
                                                                   //badgeText: "2",
    ...
    items:[
     ...
     
        {
            ...
            items: [
                ...
                //     id: 'FloatPanel_AyohaRewardEventListLoyaltyCardID',
                //     mode: 'SINGLE',
                //     //grouped: true,
                ...
                //     itemTpl: '<div class="myContent"  onclick="FloatPanel_AyohaRewardEventListSettingShow(' + "'" + '{MembershipCardCode}' + "'" + ')"  style="margin:0px 0px 0px 0px;width:100%;height:190px;background-color: #fac;background-image: url({MembershipCardBackgroundImg});background-size: 100% 100%;border-radius: 20px 20px 20px 20px;box-shadow: 5px 2px 18px #888888;">' +
...

                {
                   ...
                   store:_DataStore_AyohaRewardEventLoadByEnterpriseAccNoStore,
                    id: 'FloatPanel_AyohaRewardEventListIDInner',
                    mode: 'SINGLE',
                    //grouped: true,
                    disableSelection: true,
                    scrollable: {
                    ...
                    // style: 'background-color:rgba(255,255,255, 10);border-radius: 0px 0px 0px 0px;',
                    // itemTpl: '<div onclick="FloatPanel_AyohaRewardEventListSettingShow({ID},' + "'" + '{RewardEventCode}' + "'" + ',' + "'" + '{RewardEventName}' + "'" + ',' + "'" + '{RewardEventImgPath}' + "'" + ',' + "'" + '{RewardEventImgName}' + "'" + ',' + "'" + '{RewardEventAmount}' + "'" + ',' + "'" + '{RewardEventTermAndCondition}' + "'" + ',' + "'" + '{EnterpriseAccNo}' + "'" + ',' + "'" + '{RewardEventType}' + "'" + ',' + "'" + '{MembershipCardCode}' + "'" + ',' + "'" + '{RewardEventEndDate}' + "'" + ',' + "'" + '{RewardEventNote}' + "'" + ',' + "'" + '{isRequireRewardEventEndDate}' + "'" + ')"  class="myContent">' +
                    ...
                    //           + '<div style="width:100%;text-align:left;margin:0px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Memberships RewardEvent Campaign Name</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{RewardEventName}</div>'
                    //           + '<br>'
                    //           + '<div style="width:100%;text-align:left;margin:-17px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">RewardEvent Amount(RM)</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{RewardEventAmount}</div>'
                    //            + '<br>'
                    //           + '<div style="width:100%;text-align:left;margin:-17px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Required End Date ?</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{isRequireRewardEventEndDate}</div>'
                    //            + '<br>'
                    //           + '<div style="width:100%;text-align:left;margin:-17px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Campaign End Date</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{RewardEventEndDate}</div>'
                    //            + '<br>'
                    ...
                    //   '</div>',
                      ...
                      itemTpl: '<div class="myContent">' +
                             ...
                             + '<div style="width:100%;text-align:right;margin:-165px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;"><button  OnClick="FloatPanel_DashboardMerchantReward_MembershipEventDetailShow(' + "'" + '{EnterpriseLogo}' + "'" + ',' + "'" + '{EnterpriseName}' + "'" + ',' + "'" + '{EventCoverPhoto}' + "'" + ',' + "'" + '{EventName}' + "'" + ',' + "'" + '{EventStartDate_Day}' + "'" + ',' + "'" + '{EventStartDate_Month}' + "'" + ',' + "'" + '{EventStartTime}' + "'" + ',' + "'" + '{EventEndDate_Day}' + "'" + ',' + "'" + '{EventEndDate_Month}' + "'" + ',' + "'" + '{EventEndTime}' + "'" + ',' + "'" + '{EventLocationName}' + "'" + ',' + "'" + '{ModifiedWidth}' + "'" + ',' + "'" + '{EventDescription}' + "'" + ',' + "'" + '{EventLocationCoordinate}' + "'" + ',' + "'" + '{EventUrlTicket}' + "'" + ',' + "'" + '{EventCode}' + "'" + ',' + "'" + '{EnterpriseAccNo}' + "'" + ',' + "'" + '{RespondStatus}' + "'" + ',{ID});" class="buttonAyohaNotificationMgmt" style="margin:-300px 30px 0px 0px;"><img src="resources/icons/viewCardPurpleExt.png"  style="width:32px;height:32px;margin:0px 0px 0px 0px;zIndex:100px;" alt="Company Name"></button><br><div style="width:100%;text-align:right;margin:-15px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Preview MembershipEvent</div></div>'
                                + '<br>'
                                + '<div style="width:100%;text-align:right;margin:20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;"><button  OnClick="FloatPanel_AyohaRewardEvent_RespondListShow(' + "'" + '{EventCode}' + "'" + ',' + "'" + '{RespondStatus_IwillAttendCount}' + "'" + ',' + "'" + '{RespondStatus_InterestedCount}' + "'" + ')" class="buttonAyohaNotificationMgmt" style="margin:-300px 30px 0px 0px;"><img src="resources/icons/userlistPurple.png"  style="width:32px;height:32px;margin:0px 0px 0px 0px;zIndex:100px;" alt="Company Name"></button><br><div style="width:100%;text-align:right;margin:-15px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Members Respond</div></div>'
                                + '<br>'
                    ...
                    width: '100%',
                              ...
                              //    // hidden: true,
                              //    //  hidden:true,
                              //    id: 'tabpanelFloatPanel_AyohaRewardEventList',
...

                    {
                        ...
                        id: 'containerFloatPanel_AyohaRewardEventList_MenuBottom',
                ...
                //      id: 'btnFloatPanel_AyohaRewardEventList_Search',
                //      // hidden: true,
                //      //  badgeText: '1',
                //      margin: '0 5 0 0',
                //      height: 30,
                ...
                //  },
                //   {
                //      id: 'htmlFloatPanel_AyohaRewardRewardEvent_RewardEventRecipentsList_ListRewardEvent_ListTypeSearchTxt',
                //      margin: '0 0 0 0',
                //      width: '50%',
                //      height: 20,
                //      html: '<input type="text" id="input-FloatPanel_AyohaRewardEventList_ListTypeSearchTxt" placeHolder="Search (MembershipEvent Name)" style="border-color:purple;color:black;width:100%;text-align: center;font-size:12px;">'
                //  },
                {
                    margin: '0 0 0 0',
                 //   id: 'htmlFloatPanel_AyohaRewardEventList_count',
...
width:"75%"
                  },
                                   {
                                       ...
                                       // xtype: 'button',
                                       //  hidden: true,
                                       id: 'btnFloatPanel_AyohaRewardEventList_AddNew',
                                       //  badgeText: '1',
                                       margin: '0 0 0 0',
                                       //height: 40,
                                       //width: 135,
                                       //text: '<button class="buttonsetReceipient">Set Receipients</button>',
                                       html: '<button OnClick="FloatPanel_AyohaRewardEventSettingShow_AddNew()" class="buttonsetNewMembershipEvent" style="margin:0px 0px 0px 0px;"> <font size=3px color=white>+ </font>Add New Membership Event</button>',
                                       //ui: 'confirm',
                                       //handler: function () {
                    ...
                    // {
                    //     xtype: 'container',
                    //     id: 'FloatPanel_AyohaRewardEventListTitleOutter',
                    //  //   hidden:true,
                    //     width: '100%',
                    //     height: 45,
                    //     margin: '0 0 0 0',
                    ...
                    //         {
                    //             xtype: 'container',
                    //             id: 'containerFloatPanel_AyohaRewardEventList_StampCard',
                    //             flex: 1,
                    //             //width: '33.3%',
                    //             //height: 45,
                    //             style: "background-color: transparent",
                    ...
                    //                  {
                    //                      xtype: 'button',
                    //                      id: 'btnFloatPanel_AyohaRewardEventList_StampCard',
                    //                      //  badgeText: '1',
                    //                      margin: '-10 0 0 0',
                    //                      height: 45,
                    //                      width: 45,
                    ...
                    //                      ui: 'plain',
                    //                      handler: function () {
                    //                         // FloatPanel_AyohaRewardEventList_NewCardAddShow();
                    //                          //FloatPanel_AyohaRewardEventList_EditCardShow();
                    //                          //document.getElementById('input-FloatPanel_AyohaRewardEventList_EditCard_MembershipCardID').value = 0;
                    //                      }
                    //                  },
                    //                   {
                    //                       margin: '-9 0 0 0',
                    //                       html: '<font size=2 color=purple><b>* Select Membership Card to set RewardEvent</b></font>'
                    //                   },
    ...
    return _FloatPanel_AyohaRewardEventList;
...
function FloatPanel_AyohaRewardEventListShow() {

    Ext.Viewport.remove(_FloatPanel_AyohaRewardEventList);
    this.overlay = Ext.Viewport.add(FloatPanel_AyohaRewardEventList());
    this.overlay.show();
    isFloatPanel_AyohaRewardEventListOpen = 'Y';
    
 
   
    //FloatPanel_AyohaRewardEventList_AyohaRewardMembershipEventLoadByEnterpriseAccNoStore();
    FloatPanel_DrawerMenu_MainHide();
    FloatPanel_AyohaRewardEventList_AyohaRewardEventLoadByEnterpriseAccNoStore();
    document.getElementById("input-FloatPanel_AyohaRewardEventList_ListTypeSearchTxt").addEventListener("keyup", FloatPanel_AyohaRewardEventListSearchTxtOnKeyUp);
}
...
function FloatPanel_AyohaRewardEventListHide() {
    
   // FloatPanel_AyohaRewardEventList_AddCardHide();
    _FloatPanel_AyohaRewardEventList.hide(); isFloatPanel_AyohaRewardEventListOpen = 'N';
   
 
}

var countTotalRewardEvent;
//var _DataStore_MembershipCardLoadByEnterpriseAccNoMerchantVersionStore;
function FloatPanel_AyohaRewardEventList_AyohaRewardEventLoadByEnterpriseAccNoStore() {
   ...
   LoadingPanelShow(getLoadingIcon(), 'Loading....');
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        if(isFloatPanel_AyohaRewardEventListOpen=="Y"){
            Ext.getCmp('htmlFloatPanel_AyohaRewardEventList_count').setHtml('<font size=3 color=black><b>('+countTotalMembershipEvent+')</b></font>');
...
function FloatPanel_AyohaRewardEventListSearchTxtOnKeyUp() {


    var TotalMembershipEvent = 0;


    _DataStore_AyohaRewardEventLoadByEnterpriseAccNoStore.clearFilter();

    var queryString = document.getElementById('input-FloatPanel_AyohaRewardEventList_ListTypeSearchTxt').value;
    ...
    if (queryString) {
        ...
        _DataStore_AyohaRewardEventLoadByEnterpriseAccNoStore.filterBy(function (record) {
            if (thisRegEx.test(record.get('MembershipEventName'))) {
                console.log('ada0');

                TotalMembershipEvent = _DataStore_AyohaRewardEventLoadByEnterpriseAccNoStore.getCount();
              //  Ext.getCmp('htmlFloatPanel_AyohaRewardRewardEvent_AllMembersList_count').setHtml('<font size="2" color="black"><b>(' + countRecipientList_List + ')</b></font>');
                Ext.getCmp('htmlFloatPanel_AyohaRewardEventList_count').setHtml('<font size=3 color=black><b>('+TotalRewardEvent+')</b></font>');
        ...
        TotalMembershipEvent = _DataStore_AyohaRewardEventLoadByEnterpriseAccNoStore.getCount();
        Ext.getCmp('htmlFloatPanel_AyohaRewardEventList_count').setHtml('<font size=3 color=black><b>('+TotalMembershipEvent+')</b></font>');
...
//var StampCount;
// function Load_FloatPanel_AyohaRewardEventList_StampCampaignLoadByEnterpriseAccNoStore() {
...
//         Ext.getCmp('htmlFloatPanel_AyohaRewardEventListCardCount').setHtml('<div style="color:white;text-align: center;font-size:24px;width:100%;font-weight:bold">' + StampCount + '</div>');
//         // adjustHeight();
//         Ext.Viewport.setMasked(false);
...
// function Load_FloatPanel_AyohaRewardEventList_StampCardLoadByStampCampaignCodeEnterpriseAccNoStore(strStampCampaignCode, EnterpriseAccNo) {
...
function FloatPanel_AyohaRewardEventList_AddNew(){
    FloatPanel_AyohaRewardRewardEventList_SettingShow_AddNew();
}