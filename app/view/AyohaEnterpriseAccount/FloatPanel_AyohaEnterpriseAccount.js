...

            {
                ...
                items: [
                    ...
                    
                    {
                        ...
                        id: 'containerFloatPanel_AyohaEnterpriseAccount_MenuBottom',
                        //style: 'background-image: url("resources/icons/border5.png"); background-size: 100% 100%;',
                ...
                //      id: 'btnFloatPanel_AyohaEnterpriseAccount_Search',
                //      // hidden: true,
                //      //  badgeText: '1',
                //      margin: '0 5 0 0',
                //      height: 30,
                ...
                //  },
                //   {
                //      id: 'htmlFloatPanel_FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseName',
                //      hidden:true,
                //      margin: '0 0 0 0',
                //      width: '50%',
                //      height: 20,
                //      html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseNamex" placeHolder="Search (Name/Address)" style="border-color:purple;color:black;width:100%;text-align: center;font-size:12px;">'
                //  },
                 {
                    margin: '0 0 0 0',
                 //   hidden:true,
                  //  id: 'htmlFloatPanel_AyohaEnterpriseAccount_count',
                 ...
                 {
                    id: 'htmlFloatPanel_FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterprise',
                    hidden:true,
                    margin: '0 0 0 0',
                    width: '50%',
                    height: 20,
                    html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterprise" placeHolder="Search (Name)" style="border-color:purple;color:black;width:100%;text-align: center;font-size:12px;">'
                },
                {
                    margin: '0 0 0 0',
                    hidden:true,
                    id: 'htmlFloatPanel_AyohaEnterpriseAccount_UserEnterprisecount',
                    html: '<font size=2 color=black><b>(0)</b></font>'
                },
                 
                 {
                    xtype:'spacer',  width:"75%"                  
                                                 },
...
//                   },
                                   {
                                       ...
                                       // xtype: 'button',
                                       //  hidden: true,
                                       id: 'btnFloatPanel_AyohaEnterpriseAccount_AddNew',
                                       //  badgeText: '1',
                                       margin: '-2 0 0 0',
                                       //height: 40,
                                       //width: 135,
                                       //text: '<button class="buttonsetReceipient">Set Receipients</button>',
                                       html: '<button OnClick="FloatPanel_AyohaEnterpriseAccount_EnterpriseDetailsAddNewShow()" class="buttonsetNewMembershipEvent" style="margin:0px 0px 0px 0px;"> <font size=3px color=white>+ </font>Add New Enterprise</button>',
                                       //ui: 'confirm',
                                       //handler: function () {
                                   ...
                                   },
                                   {
                                    ...
                                    // xtype: 'button',
                                    hidden: true,
                                    id: 'btnFloatPanel_AyohaEnterpriseAccountUserEnterprise_AddNew',
                                    //  badgeText: '1',
                                    margin: '-2 0 0 0',
                                    //height: 40,
                                    //width: 135,
                                    //text: '<button class="buttonsetReceipient">Set Receipients</button>',
                                    html: '<button OnClick="FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsAddNewShow()" class="buttonsetNewMembershipEvent" style="margin:0px 0px 0px 0px;"> <font size=3px color=white>+ </font>Add New User</button>',
                                    //ui: 'confirm',
                                    //handler: function () {
                ...
                html:'<div class="search-container">'+
                    '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseName"  placeHolder="Search (Name/Address)" class="search-input" >'+
                '</div>'
                                        },
                                        {
                                            hidden:true,
                                            id: 'htmlFloatPanel_FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterprise',
                html:'<div class="search-container">'+
                    '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterprise"  placeHolder="Search (Name)" class="search-input" >'+
                '</div>'
                                        },
                                                      {
                                                          xtype: 'spacer',
    ...
    items: [
...

          {
...

            {
                ...
                width: '100%',
                height: 20,
                html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterprisePhotoName"  readOnly style="border-color:black;color:black;width:100%;text-align: right;font-size:12px;">'
        ...
        {
            margin: '-2 0 0 0',
            id: 'FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDOB',
            width: '100%',
            height: 20,
            html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDOB" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             width: '100%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseRegisterDate" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseEnterpriseAccNo"  style="border-color:white;color:white;width:100%;text-align: left;font-size:12px;">'
...

              {
                  ...
                  width: '100%',
                  height: 20,
                  html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseUserType" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

        {
            ...
            width: '100%',
            height: 20,
            html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseUserStatus"  readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

         {
             ...
             width: '100%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseLastLoginDate" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

  {
      ...
      html: '<font size=2 color=white>UserName</font>',
...

         {
             ...
             width: '100%',
             height: 20,
             html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseUserName"  readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                    {
                        ...
                        items: [
                            ...
                            //  },
                             ...
                             //    store:_DataStore_EnterprisesLoadByEnterpriseHQAccNoStore,
                             ...
                             //},

                              {
                                  ...
                                  // store: 'EnterprisesLoadByEnterpriseHQAccNoStore',
                                store: _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore,
                                  id: 'FloatPanel_AyohaEnterpriseAccount_EnterprisesListListIDLatest',
                                  mode: 'SINGLE',
                                  disableSelection: true,
                                  style: 'background-color:rgba(255,255,255, 10);border-radius: 0px 0px 0px 0px;',
                                  itemTpl: '<div class="myContent" onClick="FloatPanel_AyohaEnterpriseAccount_EnterpriseDetailsShow(' + "'" + '{EnterpriseAccNo}' + "'" + ')">' +
                                 
                                //   '<table style="border-collapse:collapse;border-spacing:0;width:100%;background-color:white;" ><thead><tr><th style="background-color:transparent;border-radius: 10px 0px 0px 10px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;font-color:white;overflow:hidden;padding:5px 5px;text-align:center;vertical-align:middle;word-break:normal" rowspan="2"><img src="{EnterpriseLogoPath}"style="width: 60px; height: 60px; margin-top: 5px; border:1px none #A2CDF5; border-radius: 50%; max-width:100px; " /></th><th style="background-color:transparent;border-color:transparent;border-right:1px none grey;font-family:Arial, sans-serif;font-size:11px;font-weight:normal;color:black;overflow:hidden;padding:5px 5px;text-align:left;vertical-align:top;word-break:normal" rowspan="2"><font size=3><b>{EnterpriseName}</b></font><br><div style="width:100%;text-align:left;margin:-7px 0px 0px 0px"><font size=1><b>({EnterpriseRegistrationNo})-{EnterpriseType}</b></font></div><br><div style="width:100%;text-align:left;margin:-15px 0px 0px 0px">{EnterpriseAddress}<br>Phone Nos:{EnterprisePhoneNo}<br>Email:{EnterpriseEmail}</div></div></th></tr><tr></tr></thead></table>' +
                                     '<table style="margin:7px 0px 0px 0px;border-collapse:collapse;border-spacing:0;width:100%;background-color:white;height:70px" ><thead><tr><th style="background-color:transparent;border-radius: 0px 0px 0px 0px;font-family:Arial, sans-serif;font-size:14px;font-weight:normal;font-color:white;overflow:hidden;padding:5px 0px;text-align:center;vertical-align:middle;word-break:normal;width:150px;height:60px;" rowspan="2"><img src="{EnterpriseLogoPath}"style="width: 60px; height: 60px; margin-top: 5px; border:1px none #A2CDF5; border-radius: 50%; max-width:100px; " /></th><th style="background-color:transparent;border-color:transparent;border-right:1px none grey;font-family:Arial, sans-serif;font-size:11px;font-weight:normal;color:black;overflow:hidden;padding:5px 0px;text-align:left;vertical-align:top;word-break:normal" rowspan="2"><font size=3><b>{EnterpriseName}</b></font><br><div style="width:100%;text-align:left;margin:-7px 0px 0px 0px"><font size=1><b>({EnterpriseRegistrationNo})-{EnterpriseType}</b></font></div><br><div style="width:100%;text-align:left;margin:-15px 0px 0px 0px">{EnterpriseAddress}<br>Phone No:{EnterprisePhoneNo}<br>Email:{EnterpriseEmail}</div></div></th></tr><tr></tr></thead></table>' +
...

                    {
                        ...
                        items: [
...

                             {
                                 ...
                                 disableSelection: true,
                                 style: 'background-color:rgba(255,255,255, 10);border-radius: 0px 0px 0px 0px;',
                                 itemTpl: '<div class="myContent" onClick="FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsShow(' + "'" + '{AccountNo}' + "'" + ')">' +
                                '<div style="background-color:transparent;border-color:#ffffff;border-style:none;border-width:1px;font-family:Arial, sans-serif;font-size:12px;font-weight:normal;color:black;overflow:hidden;padding:0px 0px;text-align:left;vertical-align:top;word-break:normal"><font size=3><b>{AccountName}</b></font><br>{UserType}</div>' +
...
document.getElementById("input-FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseName").addEventListener("keyup", FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseNameOnKeyUp);
document.getElementById("input-FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterprise").addEventListener("keyup", FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterpriseOnKeyUp);


//Ext.getCmp('htmlFloatPanel_FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseName').setHidden(true);
//htmlFloatPanel_FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterprise
...
//var StampCount;
var globalFloatPanel_AyohaEnterpriseAccount_Enterprisecount=0;
...
function Load_FloatPanel_AyohaEnterpriseAccount_EnterprisesLoadByEnterpriseHQAccNoStore() {
    ...
    _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.getProxy().setExtraParam('EnterpriseHQAccNo', GetEnterpriseHQAccNo());
    _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.getProxy().setUrl(GetAPIurl() + '/Enterprises/EnterprisesLoadByEnterpriseHQAccNo');

    _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.load();
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
       ...
       // _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.load();
        var count = _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.getCount();
      //  Ext.getCmp('FloatPanel_AyohaEnterpriseAccount_EnterprisesListListID').setStore(_DataStore_EnterprisesLoadByEnterpriseHQAccNoStore);
       //comment on 22/12/2023
      //Ext.getCmp('htmlEnterprisesListCount').setHtml('<div style="color:white;text-align: center;font-size:24px;width:100%;font-weight:bold">' + count + '</div>');
      globalFloatPanel_AyohaEnterpriseAccount_Enterprisecount=parseInt(count);
        globalcountTotalEnterprise=count;
        Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_count').setHtml('<font size=3 color=black>('+count+')</font>');
        Ext.Viewport.setMasked(false);
...
var _DataStore_AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore;
var globalUserEnterprisecount;
function Load_FloatPanel_AyohaEnterpriseAccount_AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore() {
 // alert(GetEnterpriseHQAccNo())
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        _DataStore_AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore= Ext.getStore('AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore');
        var count = myStore.getCount();
        globalUserEnterprisecount=count;

         Ext.getCmp('htmlUserEnterprisesListCount').setHtml('<div style="color:black;text-align: center;font-size:24px;width:100%;font-weight:bold">' + count + '</div>');
         Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_UserEnterprisecount').setHtml('<font size=3;color=black><b>('+count+')</b></font>');
         


         Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_TitleHeaderTxt').setHtml("<font size=4 color=black><b>User List</b></font>");          
          Ext.getCmp('btnFloatPanel_AyohaEnterpriseAccount_AddNew').setHidden(true); 
          Ext.getCmp('btnFloatPanel_AyohaEnterpriseAccountUserEnterprise_AddNew').setHidden(false);  
          Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_count').setHidden(true);
          Ext.getCmp('htmlFloatPanel_FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseName').setHidden(true);
          Ext.getCmp('htmlFloatPanel_FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterprise').setHidden(false);
           Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_UserEnterprisecount').setHidden(false);
        Ext.Viewport.setMasked(false);
            ...
            success: function (result, request) {
                ...
                if (data.success == "true") {
                    ...
                    if (data.total > 0) {
                        ...
                        Ext.getCmp('FloatPanel_AyohaEnterpriseAccount_UserEnterprisePicProfile').setHtml('<img src=' + data.results[0].Photo  + '  style="width:150px;height:150px;border-radius: 50%;"/>');
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterprisePhotoName').value = data.results[0].PhotoName;
                        // document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterprisePhoto').value = modelRecord.get('Photo');
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseID').value = data.results[0].AyohaEnterpriseUserID;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseAccountNo').value = data.results[0].AccountNo;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseAccountName').value = data.results[0].AccountName;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseEmail').value = data.results[0].Email;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterprisePhoneNumber').value = data.results[0].PhoneNumber;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDOB').value = data.results[0].DOB;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseRegisterDate').value = data.results[0].RegisterDate;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseIsUserVerified').value = data.results[0].IsUserVerified;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseVerifyString').value = data.results[0].VerifyString;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseVeriyDate').value =data.results[0].VeriyDate;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseModifiedBy').value =data.results[0].ModifiedBy;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseModifiedDate').value =data.results[0].ModifiedDate;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseEnterpriseAccNo').value =data.results[0].EnterpriseAccNo;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseUserType').value =data.results[0].UserType;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseUserStatus').value =data.results[0].UserStatus;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseLastLoginDate').value =data.results[0].LastLoginDate;


                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseUserName').value =data.results[0].UseName;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterprisePassword').value =data.results[0].Password;
                        document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_UserEnterprisePasswordTxT').value =data.results[0].Password;
...
function FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseNameOnKeyUp(){
    var TotalEnterprise = 0;


    _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.clearFilter();

    var queryString = document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_EnterpriseName').value;
    ...
    if (queryString) {
        ...
        _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.filterBy(function (record) {
            if (thisRegEx.test(record.get('EnterpriseAddress'))) {
                console.log('ada0');

                TotalEnterprise = _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.getCount();
              //  Ext.getCmp('htmlFloatPanel_AyohaRewardVoucher_AllMembersList_count').setHtml('<font size="2" color="black"><b>(' + countRecipientList_List + ')</b></font>');
                Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_count').setHtml('<font size=3 color=black><b>('+TotalEnterprise+')</b></font>');
        ...
        _DataStore_EnterprisesLoadByEnterpriseHQAccNoStore.clearFilter();
        Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_count').setHtml('<font size=3 color=black><b>('+globalcountTotalEnterprise+')</b></font>');
...
function FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterpriseOnKeyUp(){
   // _DataStore_AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore




    var TotalUserEnterprise = 0;


    Ext.getStore('AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore').clearFilter();

    var queryString = document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_ListTypeSearchTxt_UserEnterprise').value;
    ...
    if (queryString) {
        ...
        var thisRegEx = new RegExp(queryString, "i");
        Ext.getStore('AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore').filterBy(function (record) {
            if (thisRegEx.test(record.get('AccountName'))) {
                console.log('ada0');

                TotalUserEnterprise = Ext.getStore('AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore').getCount();
              //  Ext.getCmp('htmlFloatPanel_AyohaRewardVoucher_AllMembersList_count').setHtml('<font size="2" color="black"><b>(' + countRecipientList_List + ')</b></font>');
                Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_UserEnterprisecount').setHtml('<font size=3 color=black><b>('+TotalUserEnterprise+')</b></font>');
        ...
        Ext.getStore('AyohaEnterprisesUserLoadByEnterpriseHQAccNoStore').clearFilter();
        Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_UserEnterprisecount').setHtml('<font size=3 color=black><b>('+globalUserEnterprisecount+')</b></font>');
