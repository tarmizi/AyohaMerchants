...
width:20
                                    ...
                                    
                                     {
                                         ...
                                         html: '<font size=4 color=black><b>Add New User</b></font>'
                                     },
                                      {
                                          xtype: 'spacer',
...
width:20
    ...
    {
        xtype: 'button',
        id:'txtbtn_FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetails_Delete',
        //  badgeText: '1',
        margin: '7 0 0 5',
        //height: 40,
        //width: 130,
...
//                 text: '<button class="buttonDelete_web">Deletexxxxxxxxxxx</button>',
                                ...
                                items: [
...

                                    {
                                        ...
                                        items: [
                                             {
                                                 ...
                                                 html: '<font size=3 color=black><b>User Profile</b></font>',
...

                                              {
...

                                                {
                                                    ...
                                                    width: '100%',
                                                    height: 20,
                                                    html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsPhotoName"  readOnly style="border-color:black;color:black;width:100%;text-align: right;font-size:12px;">'
...

                                             {
                                                 ...
                                                 width: '80%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsPhoto"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
                                             ...
                                             },
                                            {
                                             ...
                                             {
                                                 id: 'FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsID_ID',
                                                 hidden: true,
                                                 margin: '-2 0 0 0',
                                                 width: '80%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsID"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 ...
                                                 //width: '80%',
                                                 //height: 20,
                                                 //html: '<input type="textarea" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsPhoneNumber"  style="border-color:black;color:black;width:100%;height:35px;text-align: left;font-size:12px;">'
                                                 ...
                                                 width: '80%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsAccountNo"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsAccountName"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsEmail"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 ...
                                                 html: '<font size=2 color=black>*Phone Number</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsPhoneNumber"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
                                                              ...
                                                              items: [
...

                                                                  {
                                                                      ...
                                                                      items: [
                                                                      {
                                                                          ...
                                                                          html: '<font size=2 color=black>Date Of Birth</font>',
                                            ...
                                            {
                                                margin: '-2 0 0 0',
                                                id: 'FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsDOB',
                                                width: '100%',
                                                height: 20,
                                                html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsDOB" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsRegisterDate" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 margin: '13 0 0 0',
                                                 hidden: true,
                                                 html: '<font size=2 color=black>IsUserVerified</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsIsUserVerified"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 margin: '13 0 0 0',
                                                 hidden: true,
                                                 html: '<font size=2 color=black>VerifyString</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsVerifyString"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'

                                             },
                                             {
                                                 margin: '13 0 0 0',
                                                 hidden: true,
                                                 html: '<font size=2 color=black>Verify Date</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsVeriyDate"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                              {
                                                  margin: '13 0 0 0',
                                                  hidden: true,
                                                  html: '<font size=2 color=black>ModifiedBy</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsModifiedBy"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'

                                             },
                                             {
                                                 margin: '13 0 0 0',
                                                 hidden: true,
                                                 html: '<font size=2 color=black>ModifiedDate</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsModifiedDate"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'

                                             },
                                              {
                                                  margin: '13 0 0 0',
                                                  hidden: true,
                                                  html: '<font size=2 color=black>EnterpriseAccNo</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsEnterpriseAccNo"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
                                                                    ...
                                                                    items: [
...

                                                                        {
                                                                            ...
                                                                            items: [
                                                                            {
                                                                                ...
                                                                                html: '<font size=2 color=black>*User Type</font>',
...

                                                  {
                                                      ...
                                                      width: '100%',
                                                      height: 20,
                                                      html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsUserType" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
                                                                      ...
                                                                      items: [
                                                                       {
                                                                           ...
                                                                           html: '<font size=2 color=black>*UserStatus</font>',
...

                                            {
                                                ...
                                                width: '100%',
                                                height: 20,
                                                html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsUserStatus"  readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 ...
                                                 html: '<font size=2 color=black>LastLoginDate</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsLastLoginDate" readOnly style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                     {
                                         ...
                                         html: '<font size=3 color=black><b>Login</b></font>',
...

                                      {
                                          ...
                                          html: '<font size=2 color=black>*User Name</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsUserName"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'

                                             },
                                             {
                                                 margin: '15 0 0 0',

                                                 html: '<font size=2 color=black>*Password</font>',
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="password" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsPassword"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...

                                             {
                                                 ...
                                                 width: '100%',
                                                 height: 20,
                                                 html: '<input type="text" id="input-FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsPasswordTxT"  style="border-color:black;color:black;width:100%;text-align: left;font-size:12px;">'
...
function FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsShow(AccountNo) {
    ...
    Ext.getCmp('txtbtn_FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetails_Delete').setHidden(false);
...
function FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetailsAddNewShow() {
    ...
    Ext.getCmp('txtbtn_FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetails_Delete').setHidden(true);
    Ext.getCmp('btn_FloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetails_Save').setHidden(false);
    Ext.getCmp('htmlFloatPanel_AyohaEnterpriseAccount_UserEnterpriseDetails_TitleHeaderTxt').setHtml('<font size=4 color=black><b>Add New User</b></font>')
}
