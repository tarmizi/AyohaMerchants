...
Ext.define('ianMizi.view.QrCodeScanner.Scan_QRCode_StampCard_Process', {

});



function Scan_QRCode_VerifyQRCodeStampCampaign(QrCode) {
    //var TempStampQRCode = GetCurrStampCardQrCode();
    localStorage.setItem('CurrStampCardQrCode',QrCode);
   // Ext.getCmp('FloatPanel_QrCodeScanner_ProcessLbl').setHtml('<div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;">Processing...</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Verify QR Code:' + QrCode + '</div>');
    ...
    Ext.getStore('LoyaltyStampCheckExistingStampQrCodeStore').getProxy().setExtraParams({
        StampQrCode: QrCode
    });

    Ext.StoreMgr.get('LoyaltyStampCheckExistingStampQrCodeStore').load();
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        Ext.StoreMgr.get('LoyaltyStampCheckExistingStampQrCodeStore').load();
        var myStore = Ext.getStore('LoyaltyStampCheckExistingStampQrCodeStore');
...
function Scan_QRCode_StampCard(QrCode) {
    //var TempStampQRCode = GetCurrStampCardQrCode();
    
    //Ext.getCmp('FloatPanel_QrCodeScanner_ProcessLbl').setHtml('<div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;">Processing...</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Matching QR Code:' + QrCode + '</div>');
    var TempStampQRCode = QrCode;
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        if (count >= 1) {
            ...
            var PlayerID = modelRecord.get('PlayerID');

            if (EnterpriseAccNo != GetEnterpriseHQAccNo()) {
                swalFireFail('Not Valid Qr Code!');
             //   Ext.getCmp('FloatPanel_QrCodeScanner_ProcessLbl').setHtml('<div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;">Processing....</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">QR Code:' + QrCode + ' NOT VALID !</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Enterprise Code Not Match !</div>');
                return;
            }

            //if (StampCampaignCode != GetCurrStampCampaignCode()) {
            //   // swalFireFail('Not Valid Qr Code!');
            //    Ext.getCmp('FloatPanel_QrCodeScanner_ProcessLbl').setHtml('<div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;">Processing....</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">QR Code:' + QrCode + ' NOT VALID !</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Campaign Code Not Match !</div>');
            //    return;
            //}
               ...
               Scan_QRCode_StampCard_InsertStampLoyalty(ID, StampCardCode, StampCampaignCode, EnterpriseAccNo, SubscriberAccNo, TempStampQRCode, PlayerID);
            ...
            swalFireFail('Error Qr Code!');
           // Ext.getCmp('FloatPanel_QrCodeScanner_ProcessLbl').setHtml('<div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;">Processing....</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">QR Code:' + QrCode + ' NOT VALID !</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Not Ayoha Reward QR Code !<img src="resources/icons/errorklipklip.gif" style="width:22px;height:22px;margin:0px 0px 0px 6px;"></div>');
        }
    });
    task.delay(1000);
...
function Scan_QRCode_StampCard_InsertStampLoyalty(ID, StampCardCode, StampCampaignCode, EnterpriseAccNo, SubscriberAccNo, TempStampQRCode, PlayerID) {


  //  Ext.getCmp('FloatPanel_QrCodeScanner_ProcessLbl').setHtml('<div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;">Processing.....</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">QR Code:' + TempStampQRCode + '  MATCHED !</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Stamping Process Begin..</div>');
    ...
    var _value = Ext.Ajax.request({
        ...
        success: function (result, request) {
            ...
            if (data.success == "true") {
              ...
              //  Ext.getCmp('FloatPanel_QrCodeScanner_ProcessLbl').setHtml('<div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;">Processing.....</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">QR Code:' + TempStampQRCode + '  MATCHED !</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Stamping Process Begin..</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Stamping Process Success !!!</div>');
              if(is_FloatPanel_QrCodeScanner_ScanLoyaltyStampCardOpen=='Y'){
                FloatPanel_QrCodeScanner_ScanLoyaltyStampCardHide();
                FloatPanel_AyohaCardManagement_StampQrCodeHide();
                FloatPanel_QrCodeScanner_StampSuccessAnimationShow();
             ...
             ReloadDashboard_LoadMembershipsLatestActivity();
               ...
               // Ext.getCmp('FloatPanel_QrCodeScanner_ProcessLbl').setHtml('<div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;">Processing.....</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">QR Code:' + TempStampQRCode + '  MATCHED !</div><br><div style="color:white;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Stamping Process Begin..</div><br><div style="color:red;text-align: center;border:3px none red;font-size:12px;width:100%;font-weight:bold;width:100%;margin:-20px 0px 0px 0px">Stamping Process FAILED !!!</div>');
...
function Scan_QRCode_StampCard_InsertStampLoyalty_NonQRScanner(ID, StampCardCode, StampCampaignCode, EnterpriseAccNo, SubscriberAccNo, TempStampQRCode, PlayerID) {
