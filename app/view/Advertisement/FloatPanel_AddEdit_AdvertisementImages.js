            ...
            // style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
             ...
             items: [

                 {
                     ...
                     items: [
...

                        {
                            ...
                            html: '<font size=4 color=black><b>Add Advertisement Image</b></font>'
                        },
...

                 {
                   ...
                   {
                       xtype: 'button',
                       id: 'txtbtnFloatPanel_AddEdit_AdvertisementImages_DeleteImage',
                       //  badgeText: '1',
                       margin: '7 0 0 7',
                       //height: 40,
                       //width: 130,
                   ...
                   {
                       xtype: 'button',
                       id: 'txtbtnFloatPanel_AddEdit_AdvertisementImages_SaveImage',
                       //  badgeText: '1',
                       margin: '7 0 0 7',
                       //height: 40,
                       //width: 130,
...

                {
                    ...
                    html: '<font color="black" size="2"><b>Image Name</b></font>',
...

                      {
                          ...
                          width: '95%',
                          height: 20,
                          html: '<input type="text" id="inputName-FloatPanel_AddEdit_AdvertisementImages_UploadedImage" readOnly style="border-color:grey;color:black;width:100%;text-align: left;font-size:12px;">'
                      },

                       {
                           margin: '0 0 0 0',
                           id: 'htmlLblFloatPanel_AddEdit_AdvertisementImages_ImageCaption',
                           html: '<font color="black" size="2"><b>Image Caption</b></font>',
                       },
...
function FloatPanel_AddEdit_AdvertisementImagesShow_Add() {
    ...
    Ext.getCmp('txtbtnFloatPanel_AddEdit_AdvertisementImages_DeleteImage').setHidden(true);
...
function FloatPanel_AddEdit_AdvertisementImagesShow_Edit(ImgName, ImgPath, RowID,ImgNote) {
    ...
    Ext.getCmp('txtbtnFloatPanel_AddEdit_AdvertisementImages_DeleteImage').setHidden(false);
...
function FloatPanel_AddEdit_AdvertisementImages_AdvertisementImages_Save() {
   ...
   // var ImgPaths = "https://setkita.com/AyohaImgCard/AdvertisementImage/" + GetEnterpriseAccNo() + "/" + document.getElementById('inputName-FloatPanel_AddEdit_AdvertisementImages_UploadedImage').value;
