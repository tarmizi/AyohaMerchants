                ...
                items:
                       [
...

                            {
                                ...
                                html: '<font size=4 color=black><b>My Advertisment</b></font>'
                            },
...
'<input type="text" id="input-MyAdvertisementSearchTxt"  placeHolder="Search Advertisement" class="search-input" >'+
'</div>'
},
              {
                  xtype: 'spacer',
...
{
    xtype: 'container',
    id: 'containerFloatPanel_Advertisement_Dashboard',
    width: '36%',
    height: '100%',
    //style: "background-color: white;border-right:2px solid #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px #ECF0F1 white;border-radius: 50px 50px 50px 50px;",
    style: "background-color: transparent;",
    //style: "background-color: #F35B57;",
    title: 'FloatPanel_Advertisement_Dashboard',
    layout: {
        type: 'vbox',
        pack: 'start',
        align: 'center'
    ...
    items:[
        {
         ...
         width: '100%',
            ...
            layout: {
                ...
                { 
                    margin: '25 0 0 0',
                    id: 'FloatPanel_AdvertisementVisitor_Txtx',
                    html: '<div style="width:100%;font-size:14px;color:black;text-align:center;font-weight:bold;">Advertisement Visitor - '+GetCurrentYear()+'</div>'
                },
                //{
                //    xtype: 'spacer',
                //    width:5
                ...
                {
                    xtype: 'container',
                    id: 'container_FloatPanel_AdvertisementVisitor_ID',
                    width: 30,
                    //height:270,
                 ...
                 {
                     margin: '-60 0 0 0',
                     html: '<div class="col-md-6"><div id="chart_VisitorAnalsys_Advertisement" style="width: 100%; height: 650px"></div></div>'
                 },
                 { 
                    margin: '-60 0 0 0',
...
{
    xtype: 'container',
    id: 'containerFloatPanel_Advertisement_Dashboard_border',
    width: 1,
    height: '90%',
    //style: "background-color: white;border-right:2px solid #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px #ECF0F1 white;border-radius: 50px 50px 50px 50px;",
...
{
    xtype: 'container',
    id: 'containerFloatPanel_Advertisement_Dashboard_border1',
    width: 20,
    height: '90%',
    //style: "background-color: white;border-right:2px solid #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px #ECF0F1 white;border-radius: 50px 50px 50px 50px;",
    style: "background-color: transparent;",
                                ...
                                items: [
...

                                  {
                                      ...
                                      items: [
                                        ...
                                        { margin: '25 0 0 0',
                                        id: 'FloatPanel_AdvertisementDashbord_Txt',
                                        width: '100%',
                                        html: '<div style="width:100%;font-size:14px;color:black;text-align:left;font-weight:bold;">Advertisment Status Dashboard</div>'
                                    },

                                          {
                                                                ...
                                                                items: [
                                                                    {
                                                                        ...
                                                                        items: [
                                                                             {
                                                                                 margin: '10 0 0 0',
                                                                                 html: '<div style="color:black;text-align: center;font-size:12px;width:100%;font-weight:bold">SUBMITTED</div>',
                                                                             },
                                                                              {
                                                                                  margin: '-10 0 0 0',
                                                                                  id: 'htmlAdvertisementSubmittedCount',
                                                                                  html: '<div style="color:black;text-align: center;font-size:24px;width:100%;font-weight:bold">1</div>',
                                                                              },
                                                                        ]
                                                                    },
                                                            {
                                                                ...
                                                                items: [
                                                                     {
                                                                         margin: '10 0 0 0',
                                                                         html: '<div style="color:black;text-align: center;font-size:12px;width:100%;font-weight:bold">APPROVED</div>',
                                                                     },
                                                                      {
                                                                          margin: '-10 0 0 0',
...

                                                            {
...

                                                               {
                                                                   ...
                                                                   items: [
                                                                        {
                                                                            margin: '0 0 0 0',
                                                                            html: '<div style="color:black;text-align: center;font-size:12px;width:100%;font-weight:bold">REJECTED</div>',
                                                                        },
                                                                         {
                                                                             margin: '-10 0 0 0',
                                                               ...
                                                               },
                                                               {
                                                                   ...
                                                                   items: [
                                                                        {
                                                                            margin: '0 0 0 0',
                                                                            html: '<div style="color:black;text-align: center;font-size:12px;width:100%;font-weight:bold">PUBLISHED</div>',
                                                                        },
                                                                         {
                                                                             margin: '-10 0 0 0',
                                           ...
                                           { margin: '5 0 0 0',
                                           id: 'FloatPanel_AdvertisementDashbordList_Txt',
                                           width: '100%',
                                           html: '<div style="width:100%;font-size:14px;color:black;text-align:left;font-weight:bold;">Advertisment List</div>'
                                       },
                                           {
                                               xtype: 'container',
                                               width: '100%',
                                 ...
                                 //style: 'border-right:2px none #ECF0F1;border-left:2px none #ECF0F1;border-bottom:2px solid #ECF0F1;border-top:2px none #ECF0F1 ;background: white;box-shadow: 5px 10px 18px #888888;',
                                  ...
                                  items: [
...

                                        {
                                            ...
                                            html: '<button OnClick="FloatPanel_MyAdvertisement_AddNewAdvertisement()" class="buttonsetNewMembershipEvent" style="margin:0px 0px 0px 0px;"> <font size=3px color=white>+ </font>Add New Advertisement</button>',
                                            //ui: 'confirm',
                                            //handler: function () {
                                           ...
                                           {
                                               xtype: 'button',
                                               id: 'btnFloatPanel_MyAdvertisement_AddNewold',
                                               hidden: true,
                                               //  badgeText: '1',
                                               margin: '5 0 0 -5',
                                               height: 40,
                                           ...
                                           {
                                            xtype: 'button',
                                            id: 'btnFloatPanel_MyAdvertisement_AddNew_Txt',
                                            hidden: true,
                                            margin: '7 0 0 0',
                                            //height: 40,
                                            //width: 130,
                                            html: '<font size=2 color=grey>Add New Advertisement</font>',
                                            ui: 'plain',
                                            handler: function () {
                                                FloatPanel_AdvertisementSettingAddNewShow();
                                                globalFloatPanel_AdvertisementSetting_ID = 0;
...
//        Ext.getCmp('htmlEnterprisesListCount').setHtml('<div style="color:black;text-align: center;font-size:24px;width:100%;font-weight:bold">' + count + '</div>');
...
//}
var globalFloatPanel_Advertisement_AdvertisementTitle;
var globalFloatPanel__Advertisement_AdvertismentCode;
...
function Load_FloatPanel_Advertisement_AdvertisementloadByEnterpriseHQAccNoStore() {
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        if(count>0){
            ...
            globalFloatPanel_Advertisement_AdvertisementTitle = modelRecord.get('AdvertisementTitle');
            globalFloatPanel__Advertisement_AdvertismentCode= modelRecord.get('AdvertisementCode');
            DataStore_AdvertisementSetting = Ext.getStore('AdvertisementloadByEnterpriseHQAccNoStore');
            
        }
       
       ///alert(globalFloatPanel__Advertisement_AdvertismentCode)
...
function Load_FloatPanel_Advertisement_AdvertisementDashboardCountByEnterpriseHQAccNoStore() {
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        Ext.getCmp('htmlAdvertisementSubmittedCount').setHtml('<div style="color:black;text-align: center;font-size:24px;width:100%;font-weight:bold">' + Submitted + '</div>');
        Ext.getCmp('htmlAdvertisementApprovedCount').setHtml('<div style="color:black;text-align: center;font-size:24px;width:100%;font-weight:bold">' + Approved + '</div>');
        Ext.getCmp('htmlAdvertisementRejectedCount').setHtml('<div style="color:black;text-align: center;font-size:24px;width:100%;font-weight:bold">' + Rejected + '</div>');
        Ext.getCmp('htmlAdvertisementPublishedCount').setHtml('<div style="color:black;text-align: center;font-size:24px;width:100%;font-weight:bold">' + Published + '</div>');
        }
...
function FloatPanel_MyAdvertisement_AddNewAdvertisement(){
    FloatPanel_AdvertisementSettingAddNewShow();
    globalFloatPanel_AdvertisementSetting_ID = 0;
    globalFloatPanel_Advertisement_MerchantHotVideoLinkUploadAyohaHotMerchant_AyohaHotMerchant_Code = "AHM-" + GenerateRandomNo() + "-" + GetEnterpriseAccNo();
    document.getElementById('input-FloatPanel_AdvertisementSetting_Code').value = CreateAdvertisementCode();
