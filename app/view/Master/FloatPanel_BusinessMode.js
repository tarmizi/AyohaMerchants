Ext.define('ianMizi.view.Master.FloatPanel_BusinessMode', {

});

var _FloatPanel_BusinessMode;


var isFloatPanel_BusinessModeOpen = 'N';
...
function FloatPanel_BusinessMode() {

    _FloatPanel_BusinessMode =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: 450,
         id: 'LoadingFloatPanel_BusinessModeID',
         draggable: false,
         ...
         items: {
            ...
            style: 'background-color:transparent;',
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_BusinessModeHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                ...
                                {
                                    margin: '0 0 0 0',
                                    html: '<font size=4 color=black><b>Business Mode</b></font>'
                                },
                                          
                                           {
                                             ...
                                             {
                                                xtype: 'button',
                                                id: 'btnFloatPanel_BusinessModeBack',
                                                height: 30,
                                                width: 35,
                                                // iconCls: 'list',
                                                ...
                                                handler: function () {
                                                    ...
                                                    _FloatPanel_BusinessMode.hide(Ext.fx.Animation({
                                                        type: 'popOut',
                                                        //direction: 'left',
                                                       // easing: 'cubic-bezier(.7,0,.7,1)',
                                                        duration: 250
                                                    ...
                                                    isFloatPanel_BusinessModeOpen = 'N';
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_BusinessModeBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'BusinessModeloadStore',
                        id: 'FloatPanel_BusinessModeLoadMasterListID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:12px;font-weight:normal;float:left;width:77.5%;"><b>{BusinessMode}</b></div>' +
                     ...
                     // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:67.5%;"><b>{ReceiptName}</b><br><font size=1>Upload Date:{CreatedDate}</font></div><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:17%"><b>{Amount}</b></div></div><div style="float:right;width:5%;margin:-45px 35px 0px 0px"><button class="buttonssDelete button14" OnClick="DeleteReceiptImageFromList({ID})"><img src="resources/icons/UogradeAutismeIcon/deletedustbin.png" height="30" width="30"></button></div><div style="float:right;width:5%;margin:-45px 0px 0px 0px"><button class="buttonssDelete button14" OnClick="MovementClaimReceiptImageParkingShowEdit({ID});"><img src="resources/icons/editresititem.png" height="30" width="30"></button></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                var BusinessMode = record.get('BusinessMode');
                                document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_EnterpriseDetails_BusinessMode').value = BusinessMode;
                                if (isFloatPanel_BusinessModeOpen == 'Y') {
                                    _FloatPanel_BusinessMode.hide(Ext.fx.Animation({
                                        //type: 'popOut',
                                        //easing: 'easeInOut',
                                        //duration: 250,
    ...
    return _FloatPanel_BusinessMode;
...
function FloatPanel_BusinessModeShow() {

    Ext.Viewport.remove(_FloatPanel_BusinessMode);
    this.overlay = Ext.Viewport.add(FloatPanel_BusinessMode());
    this.overlay.show();
    isFloatPanel_BusinessModeOpen = 'Y';
}


function FloatPanel_BusinessModeHide() {
    _FloatPanel_BusinessMode.hide(); isFloatPanel_BusinessModeOpen = 'N';
}
