...

                 {
                     ...
                     items:
                            [
                                          ...
                                          {
                                              margin: '0 0 0 0',
                                              html: '<font size=4 color=black><b>Branch Type</b></font>'
                                          },
                                           {
                                               xtype: 'spacer',
                ...
                items: [
...

                    {
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:12px;font-weight:normal;float:left;width:77.5%;"><b>{BranchType}</b></div>' +
