Ext.define('ianMizi.view.Master.FloatPanel_PaymentMethodList', {

});

var _FloatPanel_PaymentMethodList;


var isFloatPanel_PaymentMethodListOpen = 'N';
...
function FloatPanel_PaymentMethodList() {

    _FloatPanel_PaymentMethodList =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: 450,
         id: 'LoadingFloatPanel_PaymentMethodListID',
         draggable: false,
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_PaymentMethodList.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_PaymentMethodListOpen = 'N';
                     }
                 });
             }
         },
         ...
         items: {
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_PaymentMethodListHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                ...
                                {
                                    margin: '0 0 0 5',
                                    html: '<font size=4 color=black><b>Payment Channel</b></font>'
                                },
                                        ...
                                        
                                           {
...

                                             {
                                                xtype: 'button',
                                                margin: '0 5 0 0',
                                                id: 'btnFloatPanel_PaymentMethodListBack',
                                                height: 30,
                                                width: 35,
                                                // iconCls: 'list',
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_PaymentMethodListBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'PaymentMethodloadAllStore',
                        id: 'FloatPanel_PaymentMethodListLoadMasterListID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:16px;font-weight:normal;float:left;width:77.5%;"><b>{PaymentMethod}</b></div>' +
                     ...
                     // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:67.5%;"><b>{ReceiptName}</b><br><font size=1>Upload Date:{CreatedDate}</font></div><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:17%"><b>{Amount}</b></div></div><div style="float:right;width:5%;margin:-45px 35px 0px 0px"><button class="buttonssDelete button14" OnClick="DeleteReceiptImageFromList({ID})"><img src="resources/icons/UogradeAutismeIcon/deletedustbin.png" height="30" width="30"></button></div><div style="float:right;width:5%;margin:-45px 0px 0px 0px"><button class="buttonssDelete button14" OnClick="MovementClaimReceiptImageParkingShowEdit({ID});"><img src="resources/icons/editresititem.png" height="30" width="30"></button></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                var PaymentMethod = record.get('PaymentMethod');
                                document.getElementById('input-FloatPanel_MembershipDetails_Approve_PaymentChannel').value = PaymentMethod;
                                if (isFloatPanel_PaymentMethodListOpen == 'Y') {
                                    _FloatPanel_PaymentMethodList.hide(Ext.fx.Animation({
                                        //type: 'popOut',
                                        //easing: 'easeInOut',
                                        //duration: 250,
                                ...
                                // } else {
                                //     Ext.getCmp('containerFloatPanel_MembershipDetails_Approve_PaymentReferenceDocument').setHidden(true);
                                // }
    ...
    return _FloatPanel_PaymentMethodList;
...
function FloatPanel_PaymentMethodListShow() {

    Ext.Viewport.remove(_FloatPanel_PaymentMethodList);
    this.overlay = Ext.Viewport.add(FloatPanel_PaymentMethodList());
    this.overlay.show();
    isFloatPanel_PaymentMethodListOpen = 'Y';
}


function FloatPanel_PaymentMethodListHide() {
    _FloatPanel_PaymentMethodList.hide(); isFloatPanel_PaymentMethodListOpen = 'N';
}
