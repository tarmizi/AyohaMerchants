Ext.define('ianMizi.view.Master.FloatPanel_MembershipApprovalStatus', {

});

var _FloatPanel_MembershipApprovalStatus;


var isFloatPanel_MembershipApprovalStatusOpen = 'N';
...
function FloatPanel_MembershipApprovalStatus() {

    _FloatPanel_MembershipApprovalStatus =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 400,
         width: 450,
         id: 'LoadingFloatPanel_MembershipApprovalStatusID',
         draggable: false,
        ...
        // style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_MembershipApprovalStatus.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_MembershipApprovalStatusOpen = 'N';
                     }
                 });
             }
         },
         ...
         items: {
            ...
            // style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_MembershipApprovalStatusHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                          ...
                                          {
                                              margin: '0 0 0 0',
                                              html: '<font size=4 color=black><b>Membership Status</b></font>'
                                          },
                                           {
                                               xtype: 'spacer',
                                           ...
                                           {
                                            xtype: 'button',
                                            id: 'btnFloatPanel_MembershipApprovalStatusBack',
                                            height: 30,
                                            width: 35,
                                            // iconCls: 'list',
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_MembershipApprovalStatusBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'refMembershipStatusStore',
                        id: 'FloatPanel_MembershipApprovalStatusStoreID',
                        mode: 'SINGLE',
                        indicators:false,
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:12px;font-weight:normal;float:left;width:77.5%;"><b>{MembershipStatus}</b></div>' +
                     ...
                     // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:67.5%;"><b>{ReceiptName}</b><br><font size=1>Upload Date:{CreatedDate}</font></div><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:17%"><b>{Amount}</b></div></div><div style="float:right;width:5%;margin:-45px 35px 0px 0px"><button class="buttonssDelete button14" OnClick="DeleteReceiptImageFromList({ID})"><img src="resources/icons/UogradeAutismeIcon/deletedustbin.png" height="30" width="30"></button></div><div style="float:right;width:5%;margin:-45px 0px 0px 0px"><button class="buttonssDelete button14" OnClick="MovementClaimReceiptImageParkingShowEdit({ID});"><img src="resources/icons/editresititem.png" height="30" width="30"></button></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                var MembershipStatus = record.get('MembershipStatus');

                         
                                if (isFloatPanel_MembershipApprovalStatusOpen == 'Y') {


                                    document.getElementById('input-FloatPanel_MembershipDetails_Approve_MembershipStatusEdit').value = MembershipStatus;
                                    _FloatPanel_MembershipApprovalStatus.hide(Ext.fx.Animation({
                                        //type: 'popOut',
                                        //easing: 'easeInOut',
                                        //duration: 250,
                                ...
                                document.getElementById("input-FloatPanel_MembershipDetails_Approve_MembershipStatusEdit").style.borderColor="black";
                                isFloatPanel_MembershipApprovalStatusOpen = 'N';
    ...
    return _FloatPanel_MembershipApprovalStatus;
...
function FloatPanel_MembershipApprovalStatusShow() {

    Ext.Viewport.remove(_FloatPanel_MembershipApprovalStatus);
    this.overlay = Ext.Viewport.add(FloatPanel_MembershipApprovalStatus());
    this.overlay.show();
    isFloatPanel_MembershipApprovalStatusOpen = 'Y';
}


function FloatPanel_MembershipApprovalStatusHide() {
    _FloatPanel_MembershipApprovalStatus.hide(); isFloatPanel_MembershipApprovalStatusOpen = 'N';
}
