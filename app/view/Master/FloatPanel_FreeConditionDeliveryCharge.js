Ext.define('ianMizi.view.Master.FloatPanel_FreeConditionDeliveryCharge', {

});

var _FloatPanel_FreeConditionDeliveryCharge;


var isFloatPanel_FreeConditionDeliveryChargeOpen = 'N';


var globalFloatPanel_FreeConditionDeliveryCharge_FC_Code = "3-NR";
...
function FloatPanel_FreeConditionDeliveryCharge() {

    _FloatPanel_FreeConditionDeliveryCharge =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: 450,
         id: 'LoadingFloatPanel_FreeConditionDeliveryChargeID',
         draggable: false,
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_FreeConditionDeliveryCharge.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_FreeConditionDeliveryChargeOpen = 'N';
                     }
                 });
             }
         },
         ...
         items: {
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_FreeConditionDeliveryChargeHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                {
                                    margin: '0 0 0 0',
                                    html: '<font size=3 color=white><b>Charge Type</b></font>'
                                },
...

                                           {
                                             ...
                                             {
                                                xtype: 'button',
                                                id: 'btnFloatPanel_FreeConditionDeliveryChargeBack',
                                                height: 30,
                                                width: 35,
                                                // iconCls: 'list',
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_FreeConditionDeliveryChargeBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'FreeConditionDeliveryChargeStore',
                        id: 'FloatPanel_FreeConditionDeliveryChargeLoadMasterListID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:16px;font-weight:normal;float:left;width:77.5%;"><b>{FreeCondition}</b></div>' +
                     ...
                     // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:67.5%;"><b>{ReceiptName}</b><br><font size=1>Upload Date:{CreatedDate}</font></div><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:17%"><b>{Amount}</b></div></div><div style="float:right;width:5%;margin:-45px 35px 0px 0px"><button class="buttonssDelete button14" OnClick="DeleteReceiptImageFromList({ID})"><img src="resources/icons/UogradeAutismeIcon/deletedustbin.png" height="30" width="30"></button></div><div style="float:right;width:5%;margin:-45px 0px 0px 0px"><button class="buttonssDelete button14" OnClick="MovementClaimReceiptImageParkingShowEdit({ID});"><img src="resources/icons/editresititem.png" height="30" width="30"></button></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                var FreeCondition = record.get('FreeCondition');
                                document.getElementById('input-FloatPanel_AyohaStore_DeliveryCharge_FreeDelivery').value = FreeCondition;

                                globalFloatPanel_FreeConditionDeliveryCharge_FC_Code = record.get('FC_Code');
                                if (isFloatPanel_FreeConditionDeliveryChargeOpen == 'Y') {
                                    _FloatPanel_FreeConditionDeliveryCharge.hide(Ext.fx.Animation({
                                        //type: 'popOut',
                                        //easing: 'easeInOut',
                                        //duration: 250,
    ...
    return _FloatPanel_FreeConditionDeliveryCharge;
...
function FloatPanel_FreeConditionDeliveryChargeShow() {

    Ext.Viewport.remove(_FloatPanel_FreeConditionDeliveryCharge);
    this.overlay = Ext.Viewport.add(FloatPanel_FreeConditionDeliveryCharge());
    this.overlay.show();
    isFloatPanel_FreeConditionDeliveryChargeOpen = 'Y';
    AddRoutePages(_FloatPanel_FreeConditionDeliveryCharge, "isFloatPanel_FreeConditionDeliveryChargeOpen");
}


function FloatPanel_FreeConditionDeliveryChargeHide() {
    _FloatPanel_FreeConditionDeliveryCharge.hide(); isFloatPanel_FreeConditionDeliveryChargeOpen = 'N';
}
