Ext.define('ianMizi.view.Master.FloatPanel_RedeemApprovalStatus', {

});

var _FloatPanel_RedeemApprovalStatus;


var isFloatPanel_RedeemApprovalStatusOpen = 'N';
...
function FloatPanel_RedeemApprovalStatus() {

    _FloatPanel_RedeemApprovalStatus =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: 450,
         id: 'LoadingFloatPanel_RedeemApprovalStatusID',
         draggable: false,
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_RedeemApprovalStatus.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_RedeemApprovalStatusOpen = 'N';
                     }
                 });
             }
         },
         ...
         items: {
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_RedeemApprovalStatusHeader',
                     //style: {
                     //    // background: '#D25959',
...
width:10
                                },
                                {
                                    ...
                                    html: '<font size=4 color=black><b>Approval Status</b></font>'
                                },
                                           {
                                            ...
                                            {
                                                xtype: 'button',
                                                id: 'btnFloatPanel_RedeemApprovalStatusBack',
                                                height: 30,
                                                width: 35,
                                                // iconCls: 'list',
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_RedeemApprovalStatusBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'RedeemApprovalStatusLoadStore',
                        id: 'FloatPanel_RedeemApprovalStatusStoreID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                           ...
                           // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:16px;font-weight:normal;text-align:center;width:77.5%;"><b>{RedeemStatus}</b></div>' +
                            '<div style="overflow:auto;width:100%;height:100%;text-align:center"><div style="font-family:Arial, sans-serif;font-size:16px;font-weight:normal;float:center;width:100%;text-align:center"><b>{RedeemStatus}</b></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                var RedeemStatus = record.get('RedeemStatus');
                                ...
                                if(isFloatPanel_VIEWRedemptionListOpen == 'Y' && isFloatPanel_Redemption_UpdateStatusOpen=='N'){
                                    document.getElementById('input-FloatPanel_VIEWRedemptionList_SearchTxt_Status').value=RedeemStatus;
                                    FloatPanel_VIEWRedemptionListLoadByEnterpriseAccNoRedeemHistoryStatusYearStore(RedeemStatus,Year);
                                }
                                if(isFloatPanel_VIEWRedemptionListOpen == 'Y' && isFloatPanel_Redemption_UpdateStatusOpen=='Y'){
                                    document.getElementById('input-FloatPanel_Redemption_UpdateStatus_UpdateStatus').value = RedeemStatus;
                                }

                              
                                if (isFloatPanel_RedeemApprovalStatusOpen == 'Y') {
                                    _FloatPanel_RedeemApprovalStatus.hide(Ext.fx.Animation({
                                        type: 'popOut',
                                        easing: 'easeInOut',
                                        duration: 150,
    ...
    return _FloatPanel_RedeemApprovalStatus;
...
function FloatPanel_RedeemApprovalStatusShow() {

    Ext.Viewport.remove(_FloatPanel_RedeemApprovalStatus);
    this.overlay = Ext.Viewport.add(FloatPanel_RedeemApprovalStatus());
    this.overlay.show();
    isFloatPanel_RedeemApprovalStatusOpen = 'Y';
}


function FloatPanel_RedeemApprovalStatusHide() {
    _FloatPanel_RedeemApprovalStatus.hide(); isFloatPanel_RedeemApprovalStatusOpen = 'N';
}
