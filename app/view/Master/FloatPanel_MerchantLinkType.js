Ext.define('ianMizi.view.Master.FloatPanel_MerchantLinkType', {

});

var _FloatPanel_MerchantLinkType;


var isFloatPanel_MerchantLinkTypeOpen = 'N';
...
function FloatPanel_MerchantLinkType() {

    _FloatPanel_MerchantLinkType =
     Ext.create('Ext.Panel', {

         xtype: 'container',
         height: 350,
         width: 450,
         id: 'LoadingFloatPanel_MerchantLinkTypeID',
         draggable: false,
       ...
       //  style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
             ...
             initialize: function (c) {
                 this.element.on({
                     swipe: function (e, node, options) {
                         ...
                         if (e.direction == "left") {
                             _FloatPanel_MerchantLinkType.hide(Ext.fx.Animation({
                                 type: 'slideOut',
                                 direction: 'left',
                                 easing: 'cubic-bezier(.7,0,.7,1)',
                                 duration: 250
                         ...
                         isFloatPanel_MerchantLinkTypeOpen = 'N';
                     }
                 });
             }
         },
         ...
         items: {
            ...
            // style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
             ...
             items: [
...

                 {
                     ...
                     id: 'containerFloatPanel_MerchantLinkTypeHeader',
                     //style: {
                     //    // background: '#D25959',
                     ...
                     items:
                            [
                                ...
                                {
                                    margin: '0 0 0 0',
                                    html: '<font size=4 color=black><b>Merchant Business URL Type </b></font>'
                                },

                                           {
                                             ...
                                             {
                                                xtype: 'button',
                                                id: 'btnFloatPanel_MerchantLinkTypeBack',
                                                height: 30,
                                                width: 35,
                                                // iconCls: 'list',
...

            {
                ...
                xtype: 'container',
                margin: '10 0 0 0',
                id: 'FloatPanel_MerchantLinkTypeBorderBg',
                ...
                items: [
...

                    {
                        xtype: 'list',
                        //  flex: 1,
                        store: 'MerchantLinkTypeloadStore',
                        id: 'FloatPanel_MerchantLinkTypeLoadMasterListID',
                        mode: 'SINGLE',
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:12px;font-weight:normal;float:left;width:77.5%;"><b>{MerchantLinkType}</b></div>' +
                     ...
                     // '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:67.5%;"><b>{ReceiptName}</b><br><font size=1>Upload Date:{CreatedDate}</font></div><div style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;float:left;width:17%"><b>{Amount}</b></div></div><div style="float:right;width:5%;margin:-45px 35px 0px 0px"><button class="buttonssDelete button14" OnClick="DeleteReceiptImageFromList({ID})"><img src="resources/icons/UogradeAutismeIcon/deletedustbin.png" height="30" width="30"></button></div><div style="float:right;width:5%;margin:-45px 0px 0px 0px"><button class="buttonssDelete button14" OnClick="MovementClaimReceiptImageParkingShowEdit({ID});"><img src="resources/icons/editresititem.png" height="30" width="30"></button></div>' +
                        ...
                        listeners: {
                            ...
                            itemdoubletap: function (dataview, index, target, record, e, eOpts) {
                                ...
                                document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_EnterpriseDetails_MerchantLinkType').value = MerchantLinkType;
                                Ext.getCmp('htmlMerchantLinkType').setHtml('<font size=2 color=white>' + MerchantLinkType + ' Link/URL</font>');
                                if (isFloatPanel_MerchantLinkTypeOpen == 'Y') {
                                    _FloatPanel_MerchantLinkType.hide(Ext.fx.Animation({
                                        //type: 'popOut',
                                        //easing: 'easeInOut',
                                        //duration: 250,
    ...
    return _FloatPanel_MerchantLinkType;
...
function FloatPanel_MerchantLinkTypeShow() {

    Ext.Viewport.remove(_FloatPanel_MerchantLinkType);
    this.overlay = Ext.Viewport.add(FloatPanel_MerchantLinkType());
    this.overlay.show();
    isFloatPanel_MerchantLinkTypeOpen = 'Y';
}


function FloatPanel_MerchantLinkTypeHide() {
    _FloatPanel_MerchantLinkType.hide(); isFloatPanel_MerchantLinkTypeOpen = 'N';
}
