...
Ext.define('ianMizi.view.AyohaRewardVoucher.FloatPanel_AyohaRewardVoucherList_ListVoucher', {

});

var _FloatPanel_AyohaRewardVoucherList_ListVoucher;


var isFloatPanel_AyohaRewardVoucherList_ListVoucherOpen = 'N';
...
function FloatPanel_AyohaRewardVoucherList_ListVoucher() {

    _FloatPanel_AyohaRewardVoucherList_ListVoucher =
    Ext.create('Ext.Container', {
        ...
        height: '100%',
        width: '100%',
        id: 'FloatPanel_AyohaRewardVoucherList_ListVoucherID',
        draggable: false,
       ...
       //style: ' background-color: #fac;background-image: linear-gradient(#ff00de75, #c800ffc9);',
        ...
        //                //}
        //                if (e.direction == "left") {
        //                    _FloatPanel_AyohaRewardVoucherList_ListVoucher.hide(Ext.fx.Animation({
        //                        type: 'slideOut',
        //                        direction: 'left',
        //                        easing: 'cubic-bezier(.7,0,.7,1)',
        //                        duration: 250
                        ...
                        items: [
                            {
                                ...
                                id: 'containerFloatPanel_AyohaRewardVoucherList_ListVoucherHeader',
                               ...
                               layout: {
                                ...
                                items:
                                       [
                                           ...
                                           {
                                            margin: '0 0 0 0',
                                            id: 'htmlFloatPanel_AyohaRewardVoucherList_ListVoucher_TitleHeaderTxt',
                                            html: '<font size=4 color=black><b>Voucher Campaign Setting</b></font>'
                                        },
...
'<input type="text" id="input-FloatPanel_AyohaRewardVoucherList_ListVoucher_ListTypeSearchTxt"  placeHolder="Search (Campaign Name)" class="search-input" >'+
'</div>'
},
              {
                  xtype: 'spacer',
...

            {
                ...
                width:10
                                                      ...
                                                      {
                                                        xtype: 'button',
                                                        id: 'btnFloatPanel_AyohaRewardVoucherList_ListVoucherBack',
                                                        height: 30,
                                                        width: 35,
                                                        // iconCls: 'list',
                                                        ...
                                                        ui: 'plain',
                                                        handler: function () {
                                                           // FloatPanel_AyohaRewardVoucherList_ListVoucherHide();
                                                            // FloatPanel_AyohaRewardVoucherList_ListVoucher_AddCardHide();
                                                            isFloatPanel_AyohaRewardVoucherList_ListVoucherOpen = 'N';
                                                            _FloatPanel_AyohaRewardVoucherList_ListVoucher.hide(Ext.fx.Animation({
                                                                type: 'popOut',
                                                                //direction: 'left',
                                                                easing: 'cubic-bezier(.7,0,.7,1)',
                                                    ...
                                                    },    
                                                    {
                                                       ...
                                                       // height: 30,
                                                        width: 20,
                                                            ...
                                                            {
                                                                xtype: 'button',
                                                                id: 'btnFloatPanel_AyohaRewardVoucherList_ListVoucher_CardIcon',
                                                                height: 30,
                                                                width: 35,
                                                                hidden:true,
                                                                // iconCls: 'list',
...

 {
     ...
     width: 8,
                            ...
                            {
                                xtype: 'container',
                                id: 'containerFloatPanel_AyohaRewardVoucherList_ListVoucherStampCardList',
                               // margin: '-10 0 0 0',
                                width: '100%',
                                height: '100%',
                                ...
                                title: 'FloatPanel_AyohaRewardVoucherList_ListVoucherCardLis',
                                layout: {
                                    type: 'vbox',
                                    pack: 'center',
                                    align: 'center'
                                ...
                                //                    Ext.getCmp('tabpanelFloatPanel_AyohaRewardVoucherList_ListVoucher').setActiveItem(0);
                                //                }
                                //            }
                                //        });
                                //    }
                                                           ...
                                                           
                                                              {
...

                                                                {
                                                                    ...
                                                                    items:[
                                                                        ...
                                                                        {
                                                                            margin: '0 0 0 0',
                                                                            id: 'htmlFloatPanel_AyohaRewardVoucherList_ListVoucherCardCount',
                                                         ...
                                                         items: [
                                                               {
                                                                   ...
                                                                   margin: '2 0 0 0',
                                                                   id: 'btnFloatPanel_AyohaRewardVoucherList_ListVoucherCardImage',
                                                                   //badgeText: "2",
    ...
    items:[
     ...
     
        {
            ...
            items: [
                ...
                //     id: 'FloatPanel_AyohaRewardVoucherList_ListVoucherLoyaltyCardID',
                //     mode: 'SINGLE',
                //     //grouped: true,
...

                {
                    ...
                    store:_DataStore_AyohaRewardVoucherLoadByEnterpriseAccNoStore,
                    id: 'FloatPanel_AyohaRewardVoucherList_ListVoucherID',
                    mode: 'SINGLE',
                    //grouped: true,
                    disableSelection: true,
                    ...
                    // style: 'background-color:rgba(255,255,255, 10);border-radius: 0px 0px 0px 0px;',
                    // itemTpl: '<div onclick="FloatPanel_AyohaRewardVoucherList_ListVoucherSettingShow({ID},' + "'" + '{VoucherCode}' + "'" + ',' + "'" + '{VoucherName}' + "'" + ',' + "'" + '{VoucherImgPath}' + "'" + ',' + "'" + '{VoucherImgName}' + "'" + ',' + "'" + '{VoucherAmount}' + "'" + ',' + "'" + '{VoucherTermAndCondition}' + "'" + ',' + "'" + '{EnterpriseAccNo}' + "'" + ',' + "'" + '{VoucherType}' + "'" + ',' + "'" + '{MembershipCardCode}' + "'" + ',' + "'" + '{VoucherEndDate}' + "'" + ',' + "'" + '{VoucherNote}' + "'" + ',' + "'" + '{isRequireVoucherEndDate}' + "'" + ')"  class="myContent">' +
                    ...
                    //   '</div>',
                      ...
                      itemTpl: '<div class="myContent">' +
                                ...
                                '<div style="background-color:transparent;border-color:#ffffff;border-style:none;border-width:1px;font-family:Arial, sans-serif;font-size:12px;font-weight:normal;color:black;overflow:hidden;padding:0px 0px;text-align:left;vertical-align:top;word-break:normal">'
                                + '<div style="width:100%;text-align:left;margin:0px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;"><b>{RowNumber}).</b>Voucher Campaign Name</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{VoucherName}</div>'
                                + '<br>'
                                + '<div style="width:100%;text-align:left;margin:-17px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Voucher Amount (RM)</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{VoucherAmount}</div>'
                                 + '<br>'
                                + '<div style="width:100%;text-align:left;margin:-17px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Required End Date ?</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{isRequireVoucherEndDate}</div>'
                                 + '<br>'
                                + '<div style="width:100%;text-align:left;margin:-17px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Campaign End Date</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{ModifiedVoucherEndDate}</div>'
                                + '<br>'
                                + '<div style="width:100%;text-align:left;margin:-17px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black;">Total Recipients</div><br><div style="width:100%;text-align:left;margin:-20px 0px 0px 0px;display:block;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black;">{VocherRecipient}</div>'
                                 + '<br>'
                    ...
                    width: '100%',
                              ...
                              //    // hidden: true,
                              //    //  hidden:true,
                              //    id: 'tabpanelFloatPanel_AyohaRewardVoucherList_ListVoucher',
...

                    {
                        ...
                        id: 'containerFloatPanel_AyohaRewardVoucherList_ListVoucher_MenuBottom',
                ...
                //      id: 'btnFloatPanel_AyohaRewardVoucherList_ListVoucher_Search',
                //      // hidden: true,
                //      //  badgeText: '1',
                //      margin: '0 5 0 0',
                //      height: 30,
                ...
                //      width: '50%',
                //      height: 20,
                //      html: '<input type="text" id="input-FloatPanel_AyohaRewardVoucherList_ListVoucher_ListTypeSearchTxt" placeHolder="Search (Voucher Campaign Name)" style="border-color:purple;color:black;width:100%;text-align: center;font-size:12px;">'
                //  },
                {
                    margin: '0 0 0 0',
                   // id: 'htmlFloatPanel_AyohaRewardVoucherList_ListVoucher_count',
...
width:"78%"
                  },
                                   {
                                       ...
                                       // xtype: 'button',
                                       //  hidden: true,
                                       id: 'btnFloatPanel_AyohaRewardVoucherList_ListVoucher_AddNew',
                                       //  badgeText: '1',
                                       margin: '0 0 0 0',
                                       //height: 40,
                                       //width: 135,
                                       //text: '<button class="buttonsetReceipient">Set Receipients</button>',
                                       html: '<button OnClick="FloatPanel_AyohaRewardVoucherList_ListVoucher_AddNew()" class="buttonsetReceipient" style="margin:0px 0px 0px 0px;"> <font size=3px color=white>+ </font>Add New Vocher</button>',
                                       //ui: 'confirm',
                                       //handler: function () {
                    ...
                    // {
                    //     xtype: 'container',
                    //     id: 'FloatPanel_AyohaRewardVoucherList_ListVoucherTitleOutter',
                    //  //   hidden:true,
                    //     width: '100%',
                    //     height: 45,
                    //     margin: '0 0 0 0',
                    ...
                    //         {
                    //             xtype: 'container',
                    //             id: 'containerFloatPanel_AyohaRewardVoucherList_ListVoucher_StampCard',
                    //             flex: 1,
                    //             //width: '33.3%',
                    //             //height: 45,
                    //             style: "background-color: transparent",
                    ...
                    //                  {
                    //                      xtype: 'button',
                    //                      id: 'btnFloatPanel_AyohaRewardVoucherList_ListVoucher_StampCard',
                    //                      //  badgeText: '1',
                    //                      margin: '-10 0 0 0',
                    //                      height: 45,
                    //                      width: 45,
                    ...
                    //                      ui: 'plain',
                    //                      handler: function () {
                    //                         // FloatPanel_AyohaRewardVoucherList_ListVoucher_NewCardAddShow();
                    //                          //FloatPanel_AyohaRewardVoucherList_ListVoucher_EditCardShow();
                    //                          //document.getElementById('input-FloatPanel_AyohaRewardVoucherList_ListVoucher_EditCard_MembershipCardID').value = 0;
                    //                      }
                    //                  },
                    //                   {
                    //                       margin: '-9 0 0 0',
    ...
    return _FloatPanel_AyohaRewardVoucherList_ListVoucher;
...
function FloatPanel_AyohaRewardVoucherList_ListVoucherShow() {

    Ext.Viewport.remove(_FloatPanel_AyohaRewardVoucherList_ListVoucher);
    this.overlay = Ext.Viewport.add(FloatPanel_AyohaRewardVoucherList_ListVoucher());
    this.overlay.show();
    isFloatPanel_AyohaRewardVoucherList_ListVoucherOpen = 'Y';
    FloatPanel_AyohaCardManagement_Type = 'Voucher';
  //  FloatPanel_AyohaCardManagement_AddCardShow();
   // FloatPanel_AyohaRewardVoucherList_ListVoucher_AddCardShow();

    //Ext.getCmp('tabpanelFloatPanel_AyohaRewardVoucherList_ListVoucher').getTabBar().hide();
    //Load_FloatPanel_AyohaRewardVoucherList_ListVoucher_StampCampaignLoadByEnterpriseAccNoStore();
    //FloatPanel_AyohaRewardVoucherList_ListVoucher_AddCardShow();
    ...
    document.getElementById("input-FloatPanel_AyohaRewardVoucherList_ListVoucher_ListTypeSearchTxt").addEventListener("keyup", FloatPanel_AyohaRewardVoucherList_ListVoucherSearchTxtOnKeyUp);
}
...
function FloatPanel_AyohaRewardVoucherList_ListVoucherHide() {
    
   // FloatPanel_AyohaRewardVoucherList_ListVoucher_AddCardHide();
    _FloatPanel_AyohaRewardVoucherList_ListVoucher.hide(); isFloatPanel_AyohaRewardVoucherList_ListVoucherOpen = 'N';
...
function FloatPanel_AyohaRewardVoucherList_AyohaRewardVoucherLoadByEnterpriseAccNoStore() {
   ...
   LoadingPanelShow(getLoadingIcon(), 'Loading....');
    ...
    _DataStore_AyohaRewardVoucherLoadByEnterpriseAccNoStore.getProxy().setExtraParam('EnterpriseAccNo', GetEnterpriseAccNo());
    _DataStore_AyohaRewardVoucherLoadByEnterpriseAccNoStore.getProxy().setUrl(GetAPIurl() + '/AyohaRewardVoucher/AyohaRewardVoucherLoadByEnterpriseAccNo');
    _DataStore_AyohaRewardVoucherLoadByEnterpriseAccNoStore.load();


    var task = Ext.create('Ext.util.DelayedTask', function () {
       

        countTotalVoucher= _DataStore_AyohaRewardVoucherLoadByEnterpriseAccNoStore.getCount();  
       
        Ext.getCmp('htmlFloatPanel_AyohaRewardVoucherList_ListVoucher_count').setHtml('<font size=3 color=black><b>('+countTotalVoucher+')</b></font>');
        Ext.Viewport.setMasked(false);
        LoadingPanelHide();
...
function FloatPanel_AyohaRewardVoucherList_ListVoucherSearchTxtOnKeyUp() {


    var TotalVoucher = 0;


    _DataStore_AyohaRewardVoucherLoadByEnterpriseAccNoStore.clearFilter();

    var queryString = document.getElementById('input-FloatPanel_AyohaRewardVoucherList_ListVoucher_ListTypeSearchTxt').value;
    ...
    if (queryString) {
        ...
        _DataStore_AyohaRewardVoucherLoadByEnterpriseAccNoStore.filterBy(function (record) {
            if (thisRegEx.test(record.get('AccountName'))) {
                console.log('ada0');

                TotalVoucher = _DataStore_AyohaRewardVoucherLoadByEnterpriseAccNoStore.getCount();
              //  Ext.getCmp('htmlFloatPanel_AyohaRewardVoucher_AllMembersList_count').setHtml('<font size="2" color="black"><b>(' + countRecipientList_List + ')</b></font>');
                Ext.getCmp('htmlFloatPanel_AyohaRewardVoucherList_ListVoucher_count').setHtml('<font size=3 color=black><b>('+TotalVoucher+')</b></font>');
...
//var StampCount;
function Load_FloatPanel_AyohaRewardVoucherList_ListVoucher_StampCampaignLoadByEnterpriseAccNoStore() {
    ...
    var task = Ext.create('Ext.util.DelayedTask', function () {
        ...
        Ext.getCmp('htmlFloatPanel_AyohaRewardVoucherList_ListVoucherCardCount').setHtml('<div style="color:white;text-align: center;font-size:24px;width:100%;font-weight:bold">' + StampCount + '</div>');
        // adjustHeight();
        Ext.Viewport.setMasked(false);
...
function Load_FloatPanel_AyohaRewardVoucherList_ListVoucher_StampCardLoadByStampCampaignCodeEnterpriseAccNoStore(strStampCampaignCode, EnterpriseAccNo) {
...
function FloatPanel_AyohaRewardVoucherList_ListVoucher_AddNew(){
