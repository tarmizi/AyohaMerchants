...
function FloatPanel_AyohaRewardVoucherDetailShow(VoucherName, VoucherImage, VoucherEndDate, VoucherDayLeft, VoucherCode, VoucherAmount) {
   ...
   // var x = parseInt(window.innerHeight);
    ...
    //  Ext.getCmp('ContainerFloatPanel_AyohaRewardVoucherDetailImg').setStyle('background-image: url(https://setkita.com/AyohaImgCard/AyohaRewardContest/AdverImg/contestAdvertisement01.png); background-size: 100% 100%;background-repeat: no-repeat;');
