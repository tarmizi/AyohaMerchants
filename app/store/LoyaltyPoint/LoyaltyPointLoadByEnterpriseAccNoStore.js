Ext.define('ianMizi.store.LoyaltyPoint.LoyaltyPointLoadByEnterpriseAccNoStore', {
    extend: 'Ext.data.Store',
    //  alias: 'store.ResponderAlertGetByAcc',
    config: {
        model: 'ianMizi.model.LoyaltyPoint.LoyaltyPointSendPointHistoryModel',
        autoLoad: false,
        ...
        proxy: {
            ...
            url: GetAPIurl() + '/LoyaltyPoint/LoyaltyPointLoadByEnterpriseAccNo',
            reader: {
                type: 'json',
