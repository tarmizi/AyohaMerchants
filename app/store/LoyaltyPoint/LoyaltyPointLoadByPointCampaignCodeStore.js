Ext.define('ianMizi.store.LoyaltyPoint.LoyaltyPointLoadByPointCampaignCodeStore', {
    extend: 'Ext.data.Store',
    //  alias: 'store.ResponderAlertGetByAcc',
    config: {
        model: 'ianMizi.model.LoyaltyPoint.LoyaltyPointModel',
        autoLoad: false,
        ...
        proxy: {
            ...
            url: GetAPIurl() + '/LoyaltyPoint/LoyaltyPointLoadByPointCampaignCode',
            reader: {
                type: 'json',
