...
Ext.define('ianMizi.store.AyohaRewardContest.AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoAndSubscriberAccNoStore', {
});
...
var _DataStoreAyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoAndSubscriberAccNoStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaRewardContest.AyohaRewardContest_SelfieAndWinModel',
    id: '_AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoAndSubscriberAccNoStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaRewardContest_SelfieAndWin/AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoAndSubscriberAccNo',
        actionMethods: {
            read: 'POST'
        },
        reader: {
    ...
    grouper: {
        groupFn: function (record) {
            ...
            return '<div style="color:white;text-align: left;font-size:15px;width:100%;">Contest Name:' + record.get('ContestName') + ' | Contest Status:' + record.get('MainContestStatus') + ' | Day Left:' + record.get('DayLeft') + '</div>';
