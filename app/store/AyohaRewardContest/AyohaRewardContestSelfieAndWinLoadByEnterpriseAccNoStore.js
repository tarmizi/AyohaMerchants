...
Ext.define('ianMizi.store.AyohaRewardContest.AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoStore', {
});
...
var _DataStore_AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaRewardContest.AyohaRewardContest_SelfieAndWinModel',
    id: '_AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaRewardContest_SelfieAndWin/AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNo',
        actionMethods: {
            read: 'POST'
        },
        reader: {
