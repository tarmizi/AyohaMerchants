...
Ext.define('ianMizi.store.AyohaRewardContest.AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoAndContestCodeStore', {
});
...
var _DataStoreAyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoAndContestCodeStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaRewardContest.AyohaRewardContest_SelfieAndWinModel',
    id: '_AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoAndContestCodeStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaRewardContest_SelfieAndWin/AyohaRewardContestSelfieAndWinLoadByEnterpriseAccNoAndContestCode',
        actionMethods: {
            read: 'POST'
        },
        reader: {
