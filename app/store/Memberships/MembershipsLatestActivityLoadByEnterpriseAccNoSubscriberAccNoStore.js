Ext.define('ianMizi.store.Memberships.MembershipsLatestActivityLoadByEnterpriseAccNoSubscriberAccNoStore', {  
});




var _DataStore_MembershipsLatestActivityLoadByEnterpriseAccNoSubscriberAccNoStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.Memberships.MembershipsLatestActivityModel',
    id: '_MembershipsLatestActivityLoadByEnterpriseAccNoSubscriberAccNoStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/Memberships/MembershipsLatestActivityLoadByEnterpriseAccNoSubscriberAccNo',
        actionMethods: {
            read: 'POST'
        },
        reader: {
   ...
   // groupDir: "DESC",
    ...
    //         return '<div style="color:white;text-align: left;font-size:15px;width:100%;margin:0px 0px 0px 10px;">' + record.get('AccountName') + '</div>'
    //     },
    //    sortProperty: 'UpdatedDate'
    // }
});