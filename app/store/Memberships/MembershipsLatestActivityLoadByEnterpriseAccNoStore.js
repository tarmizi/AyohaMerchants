Ext.define('ianMizi.store.Memberships.MembershipsLatestActivityLoadByEnterpriseAccNoStore', {  
});




var _DataStore_MembershipsLatestActivityLoadByEnterpriseAccNoStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.Memberships.MembershipsLatestActivityModel',
    id: '_MembershipsLatestActivityLoadByEnterpriseAccNoStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/Memberships/MembershipsLatestActivityLoadByEnterpriseAccNo',
        actionMethods: {
            read: 'POST'
        },
        reader: {
