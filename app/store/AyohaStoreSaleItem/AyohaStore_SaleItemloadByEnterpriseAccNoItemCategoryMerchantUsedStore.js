...
Ext.define('ianMizi.store.AyohaStoreSaleItem.AyohaStore_SaleItemloadByEnterpriseAccNoItemCategoryMerchantUsedStore', {
});

var _DataStore_AyohaStore_SaleItemloadByEnterpriseAccNoItemCategoryMerchantUsedStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaStoreSaleItem.AyohaStoreSaleItemMerchantUsedModel',
    id: '_AyohaStore_SaleItemloadByEnterpriseAccNoItemCategoryMerchantUsedStore',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaStore_SaleItem/AyohaStore_SaleItemloadByEnterpriseAccNoItemCategoryMerchantUsed',
        actionMethods: {
            read: 'GET'
        },
        reader: {
