...
Ext.define('ianMizi.store.AyohaRewardEvent.AyohaRewardEventLoadByEnterpriseAccNoStore', {
});

var _DataStore_AyohaRewardEventLoadByEnterpriseAccNoStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaRewardEvent.AyohaRewardEventModel',
    id: '_AyohaRewardEventLoadByEnterpriseAccNoStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaRewardEvent/AyohaRewardEventLoadByEnterpriseAccNo',
        actionMethods: {
            read: 'POST'
        },
        reader: {
