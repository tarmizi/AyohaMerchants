...
Ext.define('ianMizi.store.AyohaRewardEvent.AyohaRewardEvent_RespondLoadByEventCodeAndEnterpriseAccNoStore', {
});

var _DataStore_AyohaRewardEvent_RespondLoadByEventCodeAndEnterpriseAccNoStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaRewardEvent.AyohaRewardEvent_RespondModel',
    id: '_AyohaRewardEvent_RespondLoadByEventCodeAndEnterpriseAccNoStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaRewardEvent_Respond/AyohaRewardEvent_RespondLoadByEventCodeAndEnterpriseAccNo',
        actionMethods: {
            read: 'POST'
        },
        reader: {
    ...
    grouper: {
        groupFn: function (record) {
            ...
            return '<div style="color:white;text-align: left;font-size:15px;width:100%;">Respond Status:' + record.get('RespondStatus') + '</div>';
