...
Ext.define('ianMizi.store.AyohaStoreOrder.AyohaStoreOrderLoadByEnterpriseAccNoAndOrderStatusMerchantStore', {
});

var _DataStore_AyohaStoreOrderLoadByEnterpriseAccNoAndOrderStatusMerchantStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaStoreOrder.AyohaStoreOrderModel',
    id: '_AyohaStoreOrderLoadByEnterpriseAccNoAndOrderStatusMerchantStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaStoreOrder/AyohaStoreOrderLoadByEnterpriseAccNoAndOrderStatusMerchant',
        actionMethods: {
            read: 'GET'
        },
        reader: {
