...
Ext.define('ianMizi.store.AyohaRewardVoucherEntitledUser.AyohaRewardVoucherEntitledUserLoadByVoucherCodeEnterpriseAccNoStore', {
});

var _DataStore_AyohaRewardVoucherEntitledUserLoadByVoucherCodeEnterpriseAccNoStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaRewardVoucherEntitledUser.AyohaRewardVoucherEntitledUser_VoucherReceipients',
    id: '_AyohaRewardVoucherEntitledUserLoadByVoucherCodeEnterpriseAccNoStoreID',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaRewardVoucher_EntitledUser/AyohaRewardVoucherEntitledUserLoadByVoucherCodeEnterpriseAccNo',
        actionMethods: {
            read: 'GET'
        },
        reader: {
