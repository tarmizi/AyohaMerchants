//can be deleted after complete dev.
Ext.define('ianMizi.store.AyohaStoreMerchant.AyohaStoreSaleItemloadByEnterpriseAccNoStore', {
});

var _DataStore_MerchantAyohaStoreSaleItemloadByEnterpriseAccNoStore = Ext.create('Ext.data.Store', {

    model: 'ianMizi.model.AyohaStoreSaleItem.AyohaStoreSaleItemMerchantUsedModel',
    id: '_MerchantAyohaStoreSaleItemloadByEnterpriseAccNoStore',
    proxy: {
        type: 'ajax',
        url: GetAPIurl() + '/AyohaStore_SaleItem/AyohaStoreSaleItemloadByEnterpriseAccNo',
        actionMethods: {
            read: 'GET'
        },
        reader: {
