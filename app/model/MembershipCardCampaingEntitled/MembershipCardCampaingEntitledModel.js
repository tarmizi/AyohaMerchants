   ...
   'CampaignDayLeft',
   {
    ...
    convert: function (value, record) {
     ...
     if (str == "Membership Card Event") {
        _value = "resources/icons/vipicon.png";
    }
...
},
{
    ...
    convert: function (value, record) {
     ...
     if (str == "Membership Card Event") {
        _value = 'https://setkita.com/AyohaImgCard/AyohaRewardMembershipPrevillageIcon/vipicon.png';
...
},
{
    ...
    convert: function (value, record) {
     ...
     if (str == "Membership Card Event") {
        _value = 'Entitled to join Membership Event';
    }
        if (str == "Privilege") {
            _value = 'Privilege';
        }
